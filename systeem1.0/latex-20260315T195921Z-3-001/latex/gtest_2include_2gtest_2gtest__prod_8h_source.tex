...
\hypertarget{gtest_2include_2gtest_2gtest__prod_8h_source}{}\label{gtest_2include_2gtest_2gtest__prod_8h_source}\index{gtest/include/gtest/gtest\_prod.h@{gtest/include/gtest/gtest\_prod.h}}
...
\DoxyCodeLine{00032\ \textcolor{comment}{//\ Google\ C++\ Testing\ Framework\ definitions\ useful\ in\ production\ code.}}
\DoxyCodeLine{00033\ }
...
\DoxyCodeLine{00043\ \textcolor{comment}{//\ \ \ void\ MyMethod();}}
\DoxyCodeLine{00044\ \textcolor{comment}{//\ \ \ FRIEND\_TEST(MyClassTest,\ MyMethod);}}
...
\DoxyCodeLine{00051\ \textcolor{comment}{//\ TEST\_F(MyClassTest,\ MyMethod)\ \{}}
\DoxyCodeLine{00052\ \textcolor{comment}{//\ \ \ //\ Can\ call\ MyClass::MyMethod()\ here.}}
\DoxyCodeLine{00053\ \textcolor{comment}{//\ \}}}
\DoxyCodeLine{00054\ }
\DoxyCodeLine{00055\ \textcolor{preprocessor}{\#define\ FRIEND\_TEST(test\_case\_name,\ test\_name)\(\backslash\)}}
\DoxyCodeLine{00056\ \textcolor{preprocessor}{friend\ class\ test\_case\_name\#\#\_\#\#test\_name\#\#\_Test}}
\DoxyCodeLine{00057\ }
\DoxyCodeLine{00058\ \textcolor{preprocessor}{\#endif\ \ }\textcolor{comment}{//\ GTEST\_INCLUDE\_GTEST\_GTEST\_PROD\_H\_}}
