...
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2quickstart-cmake}{}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2quickstart-cmake}\index{Quickstart: Building with CMake@{Quickstart: Building with CMake}}
\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2quickstart-cmake_autotoc_md238}%
\Hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2quickstart-cmake_autotoc_md238}%


This tutorial aims to get you up and running with Google\+Test using CMake. If you\textquotesingle{}re using Google\+Test for the first time or need a refresher, we recommend this tutorial as a starting point. If your project uses Bazel, see the \doxysectlink{md_cmake-build-debug_2__deps_2googletest-src_2docs_2quickstart-bazel}{Quickstart for Bazel}{0} instead.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2quickstart-cmake_autotoc_md239}{}\doxysection{\texorpdfstring{Prerequisites}{Prerequisites}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2quickstart-cmake_autotoc_md239}
...
See \doxysectlink{md_cmake-build-debug_2__deps_2googletest-src_2docs_2platforms}{Supported Platforms}{0} for more information about platforms compatible with Google\+Test.
...
\{:\+ .callout .note\} Note:\+ The terminal commands in this tutorial show a Unix shell prompt, but the commands work on the Windows command line as well.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2quickstart-cmake_autotoc_md240}{}\doxysection{\texorpdfstring{Set up a project}{Set up a project}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2quickstart-cmake_autotoc_md240}
...
For more information about how to create {\ttfamily CMake\+Lists.\+txt} files, see the \href{https://cmake.org/cmake/help/latest/guide/tutorial/index.html}{\texttt{CMake Tutorial}}.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2quickstart-cmake_autotoc_md241}{}\doxysection{\texorpdfstring{Create and run a binary}{Create and run a binary}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2quickstart-cmake_autotoc_md241}
...
Congratulations! You\textquotesingle{}ve successfully built and run a test binary using Google\+Test.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2quickstart-cmake_autotoc_md242}{}\doxysection{\texorpdfstring{Next steps}{Next steps}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2quickstart-cmake_autotoc_md242}

\begin{DoxyItemize}
\item \doxysectlink{md_cmake-build-debug_2__deps_2googletest-src_2docs_2primer}{Check out the Primer}{0} to start learning how to write simple tests.
\item \doxysectlink{md_cmake-build-debug_2__deps_2googletest-src_2docs_2samples}{See the code samples}{0} for more examples showing how to use a variety of Google\+Test features. 
\end{DoxyItemize}