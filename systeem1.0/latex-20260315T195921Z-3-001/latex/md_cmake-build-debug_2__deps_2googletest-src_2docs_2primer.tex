...
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2primer}{}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2primer}\index{Googletest Primer@{Googletest Primer}}
\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2primer_autotoc_md224}%
\Hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2primer_autotoc_md224}%
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2primer_autotoc_md225}{}\doxysection{\texorpdfstring{Introduction:\+ Why googletest?}{Introduction:\+ Why googletest?}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2primer_autotoc_md225}
...
Since googletest is based on the popular x\+Unit architecture, you\textquotesingle{}ll feel right at home if you\textquotesingle{}ve used JUnit or Py\+Unit before. If not, it will take you about 10 minutes to learn the basics and get started. So let\textquotesingle{}s go!\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2primer_autotoc_md226}{}\doxysection{\texorpdfstring{Beware of the nomenclature}{Beware of the nomenclature}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2primer_autotoc_md226}
...
googletest recently started replacing the term {\itshape Test Case} with {\itshape Test Suite}. The preferred API is {\itshape \doxylink{class_test_suite}{Test\+Suite}}. The older Test\+Case API is being slowly deprecated and refactored away.

So please be aware of the different definitions of the terms:\+


\begin{DoxyTable}{3}{}{}{1}
\SetCell{bg=\tableheadbgcolor,font=\bfseries}Meaning  &\SetCell{bg=\tableheadbgcolor,font=\bfseries}googletest Term  &\SetCell{bg=\tableheadbgcolor,font=\bfseries}\href{http://www.istqb.org/}{\texttt{ISTQB}} Term  \\
Exercise a particular program path with specific input values and verify the results  &TEST()  &\href{http://glossary.istqb.org/en/search/test\%20case}{\texttt{Test Case}}  \\
\end{DoxyTable}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2primer_autotoc_md227}{}\doxysection{\texorpdfstring{Basic Concepts}{Basic Concepts}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2primer_autotoc_md227}
...
We\textquotesingle{}ll now explain how to write a test program, starting at the individual assertion level and building up to tests and test suites.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2primer_autotoc_md228}{}\doxysection{\texorpdfstring{Assertions}{Assertions}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2primer_autotoc_md228}
...
Google\+Test provides a collection of assertions for verifying the behavior of your code in various ways. You can check Boolean conditions, compare values based on relational operators, verify string values, floating-\/point values, and much more. There are even assertions that enable you to verify more complex states by providing custom predicates. For the complete list of assertions provided by Google\+Test, see the \doxysectlink{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2assertions}{Assertions Reference}{0}.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2primer_autotoc_md229}{}\doxysection{\texorpdfstring{Simple Tests}{Simple Tests}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2primer_autotoc_md229}
To create a test:\+
...
{\bfseries{Availability}}:\+ Linux, Windows, Mac.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2primer_same-data-multiple-tests}{}\doxysection{\texorpdfstring{Test Fixtures:\+ Using the Same Data Configuration for Multiple Tests}{Test Fixtures:\+ Using the Same Data Configuration for Multiple Tests}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2primer_same-data-multiple-tests}
...
\item If necessary, write a default constructor or {\ttfamily Set\+Up()} function to prepare the objects for each test. A common mistake is to spell {\ttfamily Set\+Up()} as {\bfseries{{\ttfamily Setup()}}} with a small {\ttfamily u} -\/ Use {\ttfamily override} in C++11 to make sure you spelled it correctly.
...
\DoxyCodeLine{\textcolor{keyword}{class\ }\doxymbox{\hyperlink{class_queue}{Queue}}\ \{}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{class\ }QueueTest\ :\ \textcolor{keyword}{public}\ \doxymbox{\hyperlink{classtesting_1_1_test}{::testing::Test}}\ \{}
...
{\bfseries{Availability}}:\+ Linux, Windows, Mac.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2primer_autotoc_md230}{}\doxysection{\texorpdfstring{Invoking the Tests}{Invoking the Tests}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2primer_autotoc_md230}
...
{\bfseries{Availability}}:\+ Linux, Windows, Mac.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2primer_autotoc_md231}{}\doxysection{\texorpdfstring{Writing the main() Function}{Writing the main() Function}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2primer_autotoc_md231}
...
\DoxyCodeLine{\textcolor{keyword}{class\ }FooTest\ :\ \textcolor{keyword}{public}\ ::testing::Test\ \{}
\DoxyCodeLine{\ \textcolor{keyword}{protected}:}
...
\{:\+ .callout .note\} NOTE:\+ {\ttfamily Parse\+GUnit\+Flags()} is deprecated in favor of {\ttfamily Init\+Google\+Test()}.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2primer_autotoc_md232}{}\doxysection{\texorpdfstring{Known Limitations}{Known Limitations}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2primer_autotoc_md232}
