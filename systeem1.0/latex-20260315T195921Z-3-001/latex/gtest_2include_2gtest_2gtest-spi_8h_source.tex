...
\hypertarget{gtest_2include_2gtest_2gtest-spi_8h_source}{}\label{gtest_2include_2gtest_2gtest-spi_8h_source}\index{gtest/include/gtest/gtest-\/spi.h@{gtest/include/gtest/gtest-\/spi.h}}
...
\DoxyCodeLine{00051\ \textcolor{keyword}{class\ }GTEST\_API\_\ ScopedFakeTestPartResultReporter}
\DoxyCodeLine{00052\ \ \ \ \ :\ \textcolor{keyword}{public}\ TestPartResultReporterInterface\ \{}
...
\DoxyCodeLine{00064\ \ \ \textcolor{keyword}{explicit}\ ScopedFakeTestPartResultReporter(\doxymbox{\hyperlink{classtesting_1_1_test_part_result_array}{TestPartResultArray}}*\ result);}
\DoxyCodeLine{00065\ }
\DoxyCodeLine{00066\ \ \ \textcolor{comment}{//\ Same\ as\ above,\ but\ you\ can\ choose\ the\ interception\ scope\ of\ this\ object.}}
\DoxyCodeLine{00067\ \ \ ScopedFakeTestPartResultReporter(InterceptMode\ intercept\_mode,}
\DoxyCodeLine{00068\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \doxymbox{\hyperlink{classtesting_1_1_test_part_result_array}{TestPartResultArray}}*\ result);}
\DoxyCodeLine{00069\ }
\DoxyCodeLine{00070\ \ \ \textcolor{comment}{//\ The\ d'tor\ restores\ the\ previous\ test\ part\ result\ reporter.}}
\DoxyCodeLine{00071\ \ \ \textcolor{keyword}{virtual}\ \string~ScopedFakeTestPartResultReporter();}
\DoxyCodeLine{00072\ }
...
\DoxyCodeLine{00078\ \ \ \textcolor{keyword}{virtual}\ \textcolor{keywordtype}{void}\ ReportTestPartResult(\textcolor{keyword}{const}\ \doxymbox{\hyperlink{classtesting_1_1_test_part_result}{TestPartResult}}\&\ result);}
...
\DoxyCodeLine{00083\ \ \ TestPartResultReporterInterface*\ old\_reporter\_;}
\DoxyCodeLine{00084\ \ \ \doxymbox{\hyperlink{classtesting_1_1_test_part_result_array}{TestPartResultArray}}*\ \textcolor{keyword}{const}\ result\_;}
\DoxyCodeLine{00085\ }
\DoxyCodeLine{00086\ \ \ GTEST\_DISALLOW\_COPY\_AND\_ASSIGN\_(ScopedFakeTestPartResultReporter);}
\DoxyCodeLine{00087\ \};}
\DoxyCodeLine{00088\ }
...
\DoxyCodeLine{00096\ \textcolor{keyword}{class\ }GTEST\_API\_\ SingleFailureChecker\ \{}
\DoxyCodeLine{00097\ \ \textcolor{keyword}{public}:}
\DoxyCodeLine{00098\ \ \ \textcolor{comment}{//\ The\ constructor\ remembers\ the\ arguments.}}
\DoxyCodeLine{00099\ \ \ SingleFailureChecker(\textcolor{keyword}{const}\ \doxymbox{\hyperlink{classtesting_1_1_test_part_result_array}{TestPartResultArray}}*\ results,}
\DoxyCodeLine{00100\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ TestPartResult::Type\ \doxymbox{\hyperlink{structtesting_1_1internal_1_1_remove_const}{type}},}
\DoxyCodeLine{00101\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ \textcolor{keywordtype}{string}\&\ substr);}
\DoxyCodeLine{00102\ \ \ \string~SingleFailureChecker();}
\DoxyCodeLine{00103\ \ \textcolor{keyword}{private}:}
\DoxyCodeLine{00104\ \ \ \textcolor{keyword}{const}\ \doxymbox{\hyperlink{classtesting_1_1_test_part_result_array}{TestPartResultArray}}*\ \textcolor{keyword}{const}\ results\_;}
...
\DoxyCodeLine{00107\ }
\DoxyCodeLine{00108\ \ \ GTEST\_DISALLOW\_COPY\_AND\_ASSIGN\_(SingleFailureChecker);}
\DoxyCodeLine{00109\ \};}
\DoxyCodeLine{00110\ }
