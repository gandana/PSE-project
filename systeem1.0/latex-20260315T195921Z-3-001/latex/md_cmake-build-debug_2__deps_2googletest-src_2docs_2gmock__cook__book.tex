...
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book}{}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book}\index{gMock Cookbook@{gMock Cookbook}}
\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md118}%
\Hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md118}%


You can find recipes for using g\+Mock here. If you haven\textquotesingle{}t yet, please read \doxysectlink{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__for__dummies}{the dummy guide}{0} first to make sure you understand the basics.

\{:\+ .callout .note\} {\bfseries{Note:\+}} g\+Mock lives in the {\ttfamily testing} name space. For readability, it is recommended to write {\ttfamily using ::\+testing::\+\+Foo;} once in your file before using the name {\ttfamily Foo} defined by g\+Mock. We omit such {\ttfamily using} statements in this section for brevity, but you should do it in your own code.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md119}{}\doxysection{\texorpdfstring{Creating Mock Classes}{Creating Mock Classes}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md119}
...
\begin{DoxyItemize}
\item {\bfseries{{\ttfamily const}}} -\/ Makes the mocked method a {\ttfamily const} method. Required if overriding a {\ttfamily const} method.
\item {\bfseries{{\ttfamily override}}} -\/ Marks the method with {\ttfamily override}. Recommended if overriding a {\ttfamily virtual} method.
\item {\bfseries{{\ttfamily noexcept}}} -\/ Marks the method with {\ttfamily noexcept}. Required if overriding a {\ttfamily noexcept} method.
\item {\bfseries{{\ttfamily Calltype(...)}}} -\/ Sets the call type for the method (e.\+g. to {\ttfamily STDMETHODCALLTYPE}), useful in Windows.
\item {\bfseries{{\ttfamily ref(...)}}} -\/ Marks the method with the reference qualification specified. Required if overriding a method that has reference qualifications. Eg {\ttfamily ref(\&)} or {\ttfamily ref(\&\&)}.
\end{DoxyItemize}\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md120}{}\doxysubsection{\texorpdfstring{Dealing with unprotected commas}{Dealing with unprotected commas}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md120}
...
\end{DoxyCode}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md121}{}\doxysubsection{\texorpdfstring{Mocking Private or Protected Methods}{Mocking Private or Protected Methods}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md121}
...
\end{DoxyCode}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md122}{}\doxysubsection{\texorpdfstring{Mocking Overloaded Methods}{Mocking Overloaded Methods}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md122}
...
\end{DoxyCode}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md123}{}\doxysubsection{\texorpdfstring{Mocking Class Templates}{Mocking Class Templates}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md123}
...
\end{DoxyCode}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_MockingNonVirtualMethods}{}\doxysubsection{\texorpdfstring{Mocking Non-\/virtual Methods}{Mocking Non-\/virtual Methods}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_MockingNonVirtualMethods}
...
\end{DoxyCode}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md124}{}\doxysubsection{\texorpdfstring{Mocking Free Functions}{Mocking Free Functions}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md124}
...
If you are concerned about the performance overhead incurred by virtual functions, and profiling confirms your concern, you can combine this with the recipe for \doxysectlink{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_MockingNonVirtualMethods}{mocking non-\/virtual methods}{2}.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md125}{}\doxysubsection{\texorpdfstring{Old-\/\+Style {\ttfamily MOCK\+\_\+\+METHODn} Macros}{Old-\/\+Style {\ttfamily MOCK\+\_\+\+METHODn} Macros}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md125}
...
\begin{DoxyTable}{2}{}{}{1}
\SetCell[c=2]{bg=\tableheadbgcolor,font=\bfseries}Simple&\\
Old&{\ttfamily MOCK\+\_\+\+METHOD1(\+Foo, bool(int))}\\
New&{\ttfamily MOCK\+\_\+\+METHOD(bool, Foo, (int))}\\
\SetCell[c=2]{bg=\tableheadbgcolor,font=\bfseries}Const Method&\\
Old&{\ttfamily MOCK\+\_\+\+CONST\+\_\+\+METHOD1(\+Foo, bool(int))}\\
New&{\ttfamily MOCK\+\_\+\+METHOD(bool, Foo, (int), (const))}\\
\SetCell[c=2]{bg=\tableheadbgcolor,font=\bfseries}Method in a Class Template&\\
Old&{\ttfamily MOCK\+\_\+\+METHOD1\+\_\+\+T(\+Foo, bool(int))}\\
New&{\ttfamily MOCK\+\_\+\+METHOD(bool, Foo, (int))}\\
\SetCell[c=2]{bg=\tableheadbgcolor,font=\bfseries}Const Method in a Class Template&\\
Old&{\ttfamily MOCK\+\_\+\+CONST\+\_\+\+METHOD1\+\_\+\+T(\+Foo, bool(int))}\\
New&{\ttfamily MOCK\+\_\+\+METHOD(bool, Foo, (int), (const))}\\
\SetCell[c=2]{bg=\tableheadbgcolor,font=\bfseries}Method with Call Type&\\
Old&{\ttfamily MOCK\+\_\+\+METHOD1\+\_\+\+WITH\+\_\+\+CALLTYPE(\+STDMETHODCALLTYPE, Foo, bool(int))}\\
New&{\ttfamily MOCK\+\_\+\+METHOD(bool, Foo, (int), (Calltype(\+STDMETHODCALLTYPE)))}\\
\SetCell[c=2]{bg=\tableheadbgcolor,font=\bfseries}Const Method with Call Type&\\
Old&{\ttfamily MOCK\+\_\+\+CONST\+\_\+\+METHOD1\+\_\+\+WITH\+\_\+\+CALLTYPE(\+STDMETHODCALLTYPE, Foo, bool(int))}\\
New&{\ttfamily MOCK\+\_\+\+METHOD(bool, Foo, (int), (const, Calltype(\+STDMETHODCALLTYPE)))}\\
\SetCell[c=2]{bg=\tableheadbgcolor,font=\bfseries}Method with Call Type in a Class Template&\\
Old&{\ttfamily MOCK\+\_\+\+METHOD1\+\_\+\+T\+\_\+\+WITH\+\_\+\+CALLTYPE(\+STDMETHODCALLTYPE, Foo, bool(int))}\\
New&{\ttfamily MOCK\+\_\+\+METHOD(bool, Foo, (int), (Calltype(\+STDMETHODCALLTYPE)))}\\
\SetCell[c=2]{bg=\tableheadbgcolor,font=\bfseries}Const Method with Call Type in a Class Template&\\
Old&{\ttfamily MOCK\+\_\+\+CONST\+\_\+\+METHOD1\+\_\+\+T\+\_\+\+WITH\+\_\+\+CALLTYPE(\+STDMETHODCALLTYPE, Foo, bool(int))}\\
New&{\ttfamily MOCK\+\_\+\+METHOD(bool, Foo, (int), (const, Calltype(\+STDMETHODCALLTYPE)))}\\
\end{DoxyTable}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_NiceStrictNaggy}{}\doxysubsection{\texorpdfstring{The Nice, the Strict, and the Naggy}{The Nice, the Strict, and the Naggy}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_NiceStrictNaggy}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{using\ }::\doxymbox{\hyperlink{classtesting_1_1_nice_mock}{testing::NiceMock}};}
\DoxyCodeLine{}
\DoxyCodeLine{TEST(...)\ \{}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{using\ }::\doxymbox{\hyperlink{classtesting_1_1_strict_mock}{testing::StrictMock}};}
\DoxyCodeLine{}
\DoxyCodeLine{TEST(...)\ \{}
...
Finally, you should be {\bfseries{very cautious}} about when to use naggy or strict mocks, as they tend to make tests more brittle and harder to maintain. When you refactor your code without changing its externally visible behavior, ideally you shouldn\textquotesingle{}t need to update any tests. If your code interacts with a naggy mock, however, you may start to get spammed with warnings as the result of your change. Worse, if your code interacts with a strict mock, your tests may start to fail and you\textquotesingle{}ll be forced to fix them. Our general recommendation is to use nice mocks (not yet the default) most of the time, use naggy mocks (the current default) when developing or debugging tests, and use strict mocks only as the last resort.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_SimplerInterfaces}{}\doxysubsection{\texorpdfstring{Simplifying the Interface without Breaking Existing Code}{Simplifying the Interface without Breaking Existing Code}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_SimplerInterfaces}
...
\end{DoxyCode}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md126}{}\doxysubsection{\texorpdfstring{Alternative to Mocking Concrete Classes}{Alternative to Mocking Concrete Classes}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md126}
...
You need to weigh the pros and cons carefully for your particular problem, but I\textquotesingle{}d like to assure you that the Java community has been practicing this for a long time and it\textquotesingle{}s a proven effective technique applicable in a wide variety of situations. :\+-\/)\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_DelegatingToFake}{}\doxysubsection{\texorpdfstring{Delegating Calls to a Fake}{Delegating Calls to a Fake}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_DelegatingToFake}
...
Instead, you can define a {\ttfamily File\+Ops} interface and an {\ttfamily IOOps} interface and split {\ttfamily System}\textquotesingle{}s functionalities into the two. Then you can mock {\ttfamily IOOps} without mocking {\ttfamily File\+Ops}.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md127}{}\doxysubsection{\texorpdfstring{Delegating Calls to a Real Object}{Delegating Calls to a Real Object}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md127}
...
You can use the {\itshape delegating-\/to-\/real} technique to ensure that your mock has the same behavior as the real object while retaining the ability to validate calls. This technique is very similar to the \doxysectlink{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_DelegatingToFake}{delegating-\/to-\/fake}{2} technique, the difference being that we use a real object instead of a fake. Here\textquotesingle{}s an example:\+


\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{using\ }::testing::AtLeast;}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{keyword}{class\ }MockFoo\ :\ \textcolor{keyword}{public}\ Foo\ \{}
\DoxyCodeLine{\ \textcolor{keyword}{public}:}
...
(Why don\textquotesingle{}t we just write {\ttfamily \{ return foo.\+Concrete(str); \}}? If you do that, {\ttfamily Mock\+Foo::\+\+Concrete()} will be called (and cause an infinite recursion) since {\ttfamily Foo::\+\+Concrete()} is virtual. That\textquotesingle{}s just how C++ works.)\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md129}{}\doxysection{\texorpdfstring{Using Matchers}{Using Matchers}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md129}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md130}{}\doxysubsection{\texorpdfstring{Matching Argument Values Exactly}{Matching Argument Values Exactly}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md130}
...
\end{DoxyCode}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md131}{}\doxysubsection{\texorpdfstring{Using Simple Matchers}{Using Simple Matchers}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md131}
You can use matchers to match arguments that have a certain property:\+


\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{using\ }::testing::NotNull;}
\DoxyCodeLine{\textcolor{keyword}{using\ }::testing::Return;}
\DoxyCodeLine{...}
...
\end{DoxyCode}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_CombiningMatchers}{}\doxysubsection{\texorpdfstring{Combining Matchers}{Combining Matchers}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_CombiningMatchers}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{using\ }::testing::Contains;}
\DoxyCodeLine{\textcolor{keyword}{using\ }::testing::Property;}
\DoxyCodeLine{}
...
\end{DoxyCode}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_SafeMatcherCast}{}\doxysubsection{\texorpdfstring{Casting Matchers}{Casting Matchers}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_SafeMatcherCast}
...
Sometimes, however, you know what you\textquotesingle{}re doing and want the compiler to give you some slack. One example is that you have a matcher for {\ttfamily long} and the argument you want to match is {\ttfamily int}. While the two types aren\textquotesingle{}t exactly the same, there is nothing really wrong with using a {\ttfamily \doxylink{class_matcher}{Matcher}\texorpdfstring{$<$}{<}long\texorpdfstring{$>$}{>}} to match an {\ttfamily int} -\/ after all, we can first convert the {\ttfamily int} argument to a {\ttfamily long} losslessly before giving it to the matcher.

To support this need, g\+Mock gives you the {\ttfamily Safe\+Matcher\+Cast\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}(m)} function. It casts a matcher {\ttfamily m} to type {\ttfamily \doxylink{class_matcher}{Matcher}\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}}. To ensure safety, g\+Mock checks that (let {\ttfamily U} be the type {\ttfamily m} accepts :\+
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{using\ }::testing::SafeMatcherCast;}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{comment}{//\ A\ base\ class\ and\ a\ child\ class.}}
\DoxyCodeLine{\textcolor{keyword}{class\ }\doxymbox{\hyperlink{class_base}{Base}}\ \{\ ...\ \};}
\DoxyCodeLine{\textcolor{keyword}{class\ }Derived\ :\ \textcolor{keyword}{public}\ \doxymbox{\hyperlink{class_base}{Base}}\ \{\ ...\ \};}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{keyword}{class\ }MockFoo\ :\ \textcolor{keyword}{public}\ Foo\ \{}
\DoxyCodeLine{\ \textcolor{keyword}{public}:}
...
{\ttfamily Matcher\+Cast} essentially lets you bypass C++\textquotesingle{}s type system ({\ttfamily static\+\_\+cast} isn\textquotesingle{}t always safe as it could throw away information, for example), so be careful not to misuse/\+abuse it.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_SelectOverload}{}\doxysubsection{\texorpdfstring{Selecting Between Overloaded Functions}{Selecting Between Overloaded Functions}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_SelectOverload}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{using\ }::testing::ReturnRef;}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{keyword}{class\ }MockFoo\ :\ \textcolor{keyword}{public}\ Foo\ \{}
\DoxyCodeLine{\ \ ...}
\DoxyCodeLine{\ \ MOCK\_METHOD(Bar\&,\ GetBar,\ (),\ (\textcolor{keyword}{override}));}
...
To disambiguate overloaded functions with the same number of arguments but different argument types, you may need to specify the exact type of a matcher, either by wrapping your matcher in {\ttfamily \doxylink{class_matcher}{Matcher}\texorpdfstring{$<$}{<}type\texorpdfstring{$>$}{>}()}, or using a matcher whose type is fixed ({\ttfamily Typed\+Eq\texorpdfstring{$<$}{<}type\texorpdfstring{$>$}{>}}, {\ttfamily An\texorpdfstring{$<$}{<}type\texorpdfstring{$>$}{>}()}, etc):\+


\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{using\ }::testing::An;}
\DoxyCodeLine{\textcolor{keyword}{using\ }::\doxymbox{\hyperlink{classtesting_1_1_matcher}{testing::Matcher}};}
\DoxyCodeLine{\textcolor{keyword}{using\ }::testing::TypedEq;}
\DoxyCodeLine{}
...
\DoxyCodeLine{\ \ EXPECT\_CALL(printer,\ Print(\doxymbox{\hyperlink{class_matcher}{Matcher<int>}}(Lt(5))));\ \ \textcolor{comment}{//\ void\ Print(int);}}
...
\end{DoxyCode}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md132}{}\doxysubsection{\texorpdfstring{Performing Different Actions Based on the Arguments}{Performing Different Actions Based on the Arguments}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md132}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{using\ }::testing::\_;}
\DoxyCodeLine{\textcolor{keyword}{using\ }::testing::Lt;}
\DoxyCodeLine{\textcolor{keyword}{using\ }::testing::Return;}
\DoxyCodeLine{...}
...
Now, if {\ttfamily foo.\+Do\+This()} is called with a value less than 5, {\ttfamily \textquotesingle{}a\textquotesingle{}} will be returned; otherwise {\ttfamily \textquotesingle{}b\textquotesingle{}} will be returned.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md133}{}\doxysubsection{\texorpdfstring{Matching Multiple Arguments as a Whole}{Matching Multiple Arguments as a Whole}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md133}
...
The expression inside {\ttfamily With()} must be a matcher of type {\ttfamily \doxylink{class_matcher}{Matcher}\texorpdfstring{$<$}{<}std::\+tuple\texorpdfstring{$<$}{<}A1, ..., An\texorpdfstring{$>$}{>}\texorpdfstring{$>$}{>}}, where {\ttfamily A1}, ..., {\ttfamily An} are the types of the function arguments.
...
\DoxyCodeLine{\textcolor{keyword}{using\ }::testing::\_;}
\DoxyCodeLine{\textcolor{keyword}{using\ }::testing::AllOf;}
\DoxyCodeLine{\textcolor{keyword}{using\ }::testing::Args;}
\DoxyCodeLine{\textcolor{keyword}{using\ }::testing::Lt;}
\DoxyCodeLine{...}
...
Note that if you want to pass the arguments to a predicate of your own (e.\+g. {\ttfamily .With(Args\texorpdfstring{$<$}{<}0, 1\texorpdfstring{$>$}{>}(Truly(\&My\+Predicate)))}), that predicate MUST be written to take a {\ttfamily std::\+tuple} as its argument; g\+Mock will pass the {\ttfamily n} selected arguments as {\itshape one} single tuple to the predicate.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md134}{}\doxysubsection{\texorpdfstring{Using Matchers as Predicates}{Using Matchers as Predicates}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md134}
...
\DoxyCodeLine{}
\DoxyCodeLine{\doxymbox{\hyperlink{classvector}{vector<int>}}\ v;}
\DoxyCodeLine{...}
...
\end{DoxyCode}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md135}{}\doxysubsection{\texorpdfstring{Using Matchers in googletest Assertions}{Using Matchers in googletest Assertions}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md135}
See \href{reference/assertions.md\#EXPECT_THAT}{\texttt{{\ttfamily EXPECT\+\_\+\+THAT}}} in the Assertions Reference.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md136}{}\doxysubsection{\texorpdfstring{Using Predicates as Matchers}{Using Predicates as Matchers}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md136}
g\+Mock provides a set of built-\/in matchers for matching arguments with expected values—see the \doxysectlink{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2matchers}{Matchers Reference}{0} for more information. In case you find the built-\/in set lacking, you can use an arbitrary unary predicate function or functor as a matcher -\/ as long as the predicate accepts a value of the type you want. You do this by wrapping the predicate inside the {\ttfamily Truly()} function, for example:\+


\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{using\ }::testing::Truly;}
\DoxyCodeLine{}
...
Note that the predicate function /\+ functor doesn\textquotesingle{}t have to return {\ttfamily bool}. It works as long as the return value can be used as the condition in in statement {\ttfamily if (condition) ...}.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md137}{}\doxysubsection{\texorpdfstring{Matching Arguments that Are Not Copyable}{Matching Arguments that Are Not Copyable}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md137}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{using\ }::testing::Eq;}
\DoxyCodeLine{\textcolor{keyword}{using\ }::testing::Lt;}
\DoxyCodeLine{...}
...
Remember:\+ if you do this, don\textquotesingle{}t change {\ttfamily bar} after the {\ttfamily EXPECT\+\_\+\+CALL()}, or the result is undefined.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md138}{}\doxysubsection{\texorpdfstring{Validating a Member of an Object}{Validating a Member of an Object}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md138}
...
\begin{DoxyTable}{2}{}{}{1}
\SetCell{bg=\tableheadbgcolor,font=\bfseries}Expression  &\SetCell{bg=\tableheadbgcolor,font=\bfseries}Description  \\
{\ttfamily Field(\&Foo::\+number, Ge(3))}  &Matches {\ttfamily x} where {\ttfamily x.\+number \texorpdfstring{$>$}{>}= 3}.  \\
{\ttfamily Property(\&Foo::\+name, Starts\+With("{}John "{}))}  &Matches {\ttfamily x} where {\ttfamily x.\+name()} starts with {\ttfamily "{}John "{}}.  \\
\end{DoxyTable}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{using\ }::testing::Field;}
\DoxyCodeLine{\textcolor{keyword}{using\ }::testing::Ge;}
\DoxyCodeLine{...}
...
What if you want to validate more than one members at the same time? Remember that there are \doxysectlink{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_CombiningMatchers}{\`{}\+All\+Of()\`{} and \`{}\+All\+Of\+Array()\`{}}{2}.
...
\DoxyCodeLine{\textcolor{keyword}{using\ }::testing::SafeMatcherCast;}
\DoxyCodeLine{}
\DoxyCodeLine{\doxymbox{\hyperlink{class_matcher}{Matcher<Foo>}}\ IsFoo(\textcolor{keyword}{const}\ Foo\&\ foo)\ \{}
...
\end{DoxyCode}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md139}{}\doxysubsection{\texorpdfstring{Validating the Value Pointed to by a Pointer Argument}{Validating the Value Pointed to by a Pointer Argument}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md139}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{using\ }::testing::Ge;}
\DoxyCodeLine{\textcolor{keyword}{using\ }::testing::Pointee;}
\DoxyCodeLine{...}
...
What if you have a pointer to pointer? You guessed it -\/ you can use nested {\ttfamily Pointee()} to probe deeper inside the value. For example, {\ttfamily Pointee(Pointee(\+Lt(3)))} matches a pointer that points to a pointer that points to a number less than 3 (what a mouthful...).\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_CustomMatcherClass}{}\doxysubsection{\texorpdfstring{Defining a Custom Matcher Class}{Defining a Custom Matcher Class}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_CustomMatcherClass}
Most matchers can be simply defined using \doxysectlink{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_NewMatchers}{the MATCHER\texorpdfstring{$\ast$}{*} macros}{2}, which are terse and flexible, and produce good error messages. However, these macros are not very explicit about the interfaces they create and are not always suitable, especially for matchers that will be widely reused.
...
\DoxyCodeLine{\};}
\DoxyCodeLine{}
\DoxyCodeLine{\doxymbox{\hyperlink{classtesting_1_1_matcher}{::testing::Matcher<const\ Foo\&>}}\ BarPlusBazEq(\textcolor{keywordtype}{int}\ expected\_sum)\ \{}
...
\end{DoxyCode}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md140}{}\doxysubsection{\texorpdfstring{Matching Containers}{Matching Containers}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md140}
...
\DoxyCodeLine{\textcolor{keyword}{using\ }::testing::Gt;}
\DoxyCodeLine{...}
\DoxyCodeLine{\ \ MOCK\_METHOD(\textcolor{keywordtype}{void},\ Foo,\ (\textcolor{keyword}{const}\ \doxymbox{\hyperlink{classvector}{vector<int>}}\&\ numbers),\ (\textcolor{keyword}{override}));}
\DoxyCodeLine{...}
...
\DoxyCodeLine{\textcolor{keyword}{using\ }::testing::\_;}
\DoxyCodeLine{\textcolor{keyword}{using\ }::testing::Gt;}
\DoxyCodeLine{\textcolor{keyword}{using\ }::testing::UnorderedElementsAre;}
\DoxyCodeLine{...}
\DoxyCodeLine{\ \ MOCK\_METHOD(\textcolor{keywordtype}{void},\ Foo,\ (\textcolor{keyword}{const}\ \doxymbox{\hyperlink{classvector}{vector<int>}}\&\ numbers),\ (\textcolor{keyword}{override}));}
\DoxyCodeLine{...}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{using\ }::testing::ElementsAreArray;}
\DoxyCodeLine{...}
...
\DoxyCodeLine{\ \ \doxymbox{\hyperlink{class_matcher}{Matcher<int>}}\ expected\_vector2[]\ =\ \{1,\ Gt(2),\ \_,\ 3,\ ...\};}
...
\end{DoxyItemize}\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md141}{}\doxysubsection{\texorpdfstring{Sharing Matchers}{Sharing Matchers}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md141}
...
\DoxyCodeLine{\textcolor{keyword}{using\ }::\doxymbox{\hyperlink{classtesting_1_1_matcher}{testing::Matcher}};}
\DoxyCodeLine{...}
\DoxyCodeLine{\ \ \doxymbox{\hyperlink{class_matcher}{Matcher<int>}}\ in\_range\ =\ AllOf(Gt(5),\ Le(10));}
\DoxyCodeLine{\ \ ...\ use\ in\_range\ as\ a\ matcher\ in\ multiple\ EXPECT\_CALLs\ ...}

\end{DoxyCode}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_PureMatchers}{}\doxysubsection{\texorpdfstring{Matchers must have no side-\/effects}{Matchers must have no side-\/effects}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_PureMatchers}
...
This requirement must be satisfied no matter how a matcher is defined (e.\+g., if it is one of the standard matchers, or a custom matcher). In particular, a matcher can never call a mock function, as that will affect the state of the mock object and g\+Mock.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md142}{}\doxysection{\texorpdfstring{Setting Expectations}{Setting Expectations}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md142}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_UseOnCall}{}\doxysubsection{\texorpdfstring{Knowing When to Expect}{Knowing When to Expect}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_UseOnCall}
{\bfseries{{\ttfamily ON\+\_\+\+CALL}}} is likely the {\itshape single most under-\/utilized construct} in g\+Mock.
...
If you are bothered by the "{}\+Uninteresting mock function call"{} message printed when a mock method without an {\ttfamily EXPECT\+\_\+\+CALL} is called, you may use a {\ttfamily Nice\+Mock} instead to suppress all such messages for the mock object, or suppress the message for specific methods by adding {\ttfamily EXPECT\+\_\+\+CALL(...).Times(\+Any\+Number())}. DO NOT suppress it by blindly adding an {\ttfamily EXPECT\+\_\+\+CALL(...)}, or you\textquotesingle{}ll have a test that\textquotesingle{}s a pain to maintain.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md143}{}\doxysubsection{\texorpdfstring{Ignoring Uninteresting Calls}{Ignoring Uninteresting Calls}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md143}
If you are not interested in how a mock method is called, just don\textquotesingle{}t say anything about it. In this case, if the method is ever called, g\+Mock will perform its default action to allow the test program to continue. If you are not happy with the default action taken by g\+Mock, you can override it using {\ttfamily Default\+Value\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}::Set()} (described \doxysectlink{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2mocking_DefaultValue}{here}{2}) or {\ttfamily ON\+\_\+\+CALL()}.

Please note that once you expressed interest in a particular mock method (via {\ttfamily EXPECT\+\_\+\+CALL()}), all invocations to it must match some expectation. If this function is called but the arguments don\textquotesingle{}t match any {\ttfamily EXPECT\+\_\+\+CALL()} statement, it will be an error.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md144}{}\doxysubsection{\texorpdfstring{Disallowing Unexpected Calls}{Disallowing Unexpected Calls}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md144}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{using\ }::testing::AnyNumber;}
\DoxyCodeLine{\textcolor{keyword}{using\ }::testing::Gt;}
\DoxyCodeLine{...}
...
A call to {\ttfamily foo.\+Bar()} that doesn\textquotesingle{}t match any of the {\ttfamily EXPECT\+\_\+\+CALL()} statements will be an error.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_uninteresting-vs-unexpected}{}\doxysubsection{\texorpdfstring{Understanding Uninteresting vs Unexpected Calls}{Understanding Uninteresting vs Unexpected Calls}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_uninteresting-vs-unexpected}
...
For more on uninteresting calls, nice mocks, and strict mocks, read \doxysectlink{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_NiceStrictNaggy}{"{}The Nice, the Strict, and the Naggy"{}}{2}.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_ParameterlessExpectations}{}\doxysubsection{\texorpdfstring{Ignoring Uninteresting Arguments}{Ignoring Uninteresting Arguments}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_ParameterlessExpectations}
...
This functionality is only available when a method is not overloaded; to prevent unexpected behavior it is a compilation error to try to set an expectation on a method where the specific overload is ambiguous. You can work around this by supplying a \doxysectlink{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_SimplerInterfaces}{simpler mock interface}{2} than the mocked class provides.

This pattern is also useful when the arguments are interesting, but match logic is substantially complex. You can leave the argument list unspecified and use Save\+Arg actions to \doxysectlink{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_SaveArgVerify}{save the values for later verification}{2}. If you do that, you can easily differentiate calling the method the wrong number of times from calling it with the wrong arguments.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__for__dummies_OrderedCalls}{}\doxysubsection{\texorpdfstring{Expecting Ordered Calls}{Expecting Ordered Calls}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__for__dummies_OrderedCalls}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{using\ }::testing::\_;}
\DoxyCodeLine{\textcolor{keyword}{using\ }::testing::InSequence;}
\DoxyCodeLine{}
\DoxyCodeLine{\ \ \{}
...
In this example, we expect a call to {\ttfamily foo.\+Do\+This(5)}, followed by two calls to {\ttfamily bar.\+Do\+That()} where the argument can be anything, which are in turn followed by a call to {\ttfamily foo.\+Do\+This(6)}. If a call occurred out-\/of-\/order, g\+Mock will report an error.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_PartialOrder}{}\doxysubsection{\texorpdfstring{Expecting Partially Ordered Calls}{Expecting Partially Ordered Calls}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_PartialOrder}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{using\ }::testing::Sequence;}
\DoxyCodeLine{...}
...
This means that A must occur before B and C, and C must occur before D. There\textquotesingle{}s no restriction about the order other than these.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md145}{}\doxysubsection{\texorpdfstring{Controlling When an Expectation Retires}{Controlling When an Expectation Retires}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md145}
...
Here \#2 can be used only once, so if you have two warnings with the message {\ttfamily "{}File too large."{}}, the first will match \#2 and the second will match \#1 -\/ there will be no error.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md146}{}\doxysection{\texorpdfstring{Using Actions}{Using Actions}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md146}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md147}{}\doxysubsection{\texorpdfstring{Returning References from Mock Methods}{Returning References from Mock Methods}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md147}
...
\end{DoxyCode}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md148}{}\doxysubsection{\texorpdfstring{Returning Live Values from Mock Methods}{Returning Live Values from Mock Methods}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md148}
...
\end{DoxyCode}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md149}{}\doxysubsection{\texorpdfstring{Combining Actions}{Combining Actions}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md149}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{using\ }::testing::\_;}
\DoxyCodeLine{\textcolor{keyword}{using\ }::testing::DoAll;}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{keyword}{class\ }MockFoo\ :\ \textcolor{keyword}{public}\ Foo\ \{}
\DoxyCodeLine{\ \textcolor{keyword}{public}:}
...
\end{DoxyCode}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_SaveArgVerify}{}\doxysubsection{\texorpdfstring{Verifying Complex Arguments}{Verifying Complex Arguments}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_SaveArgVerify}
...
\end{DoxyCode}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_MockingSideEffects}{}\doxysubsection{\texorpdfstring{Mocking Side Effects}{Mocking Side Effects}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_MockingSideEffects}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{using\ }::testing::\_;}
\DoxyCodeLine{\textcolor{keyword}{using\ }::testing::SetArgPointee;}
\DoxyCodeLine{}
...
If the output argument is an array, use the {\ttfamily Set\+Array\+Argument\texorpdfstring{$<$}{<}N\texorpdfstring{$>$}{>}(first, last)} action instead. It copies the elements in source range {\ttfamily \+[first, last)} to the array pointed to by the {\ttfamily N}-\/th (0-\/based) argument:\+


\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{using\ }::testing::NotNull;}
\DoxyCodeLine{\textcolor{keyword}{using\ }::testing::SetArrayArgument;}
\DoxyCodeLine{}
...
\DoxyCodeLine{\ \ \doxymbox{\hyperlink{classvector}{vector<string>}}\ names\ =\ \{\textcolor{stringliteral}{"{}George"{}},\ \textcolor{stringliteral}{"{}John"{}},\ \textcolor{stringliteral}{"{}Thomas"{}}\};}
\DoxyCodeLine{\ \ EXPECT\_CALL(rolodex,\ GetNames(\_))}
\DoxyCodeLine{\ \ \ \ \ \ .WillOnce(SetArrayArgument<0>(names.begin(),\ names.end()));}

\end{DoxyCode}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md150}{}\doxysubsection{\texorpdfstring{Changing a Mock Object\textquotesingle{}s Behavior Based on the State}{Changing a Mock Object\textquotesingle{}s Behavior Based on the State}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md150}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{using\ }::testing::\_;}
\DoxyCodeLine{\textcolor{keyword}{using\ }::testing::SaveArg;}
\DoxyCodeLine{\textcolor{keyword}{using\ }::testing::Return;}
\DoxyCodeLine{}
...
Here {\ttfamily my\+\_\+mock.\+Get\+Prev\+Value()} will always return the argument of the last {\ttfamily Update\+Value()} call.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2mocking_DefaultValue}{}\doxysubsection{\texorpdfstring{Setting the Default Value for a Return Type}{Setting the Default Value for a Return Type}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2mocking_DefaultValue}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{using\ }::\doxymbox{\hyperlink{classtesting_1_1_default_value}{testing::DefaultValue}};}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{keyword}{class\ }MockFoo\ :\ \textcolor{keyword}{public}\ Foo\ \{}
\DoxyCodeLine{\ \textcolor{keyword}{public}:}
...
Please note that changing the default value for a type can make your tests hard to understand. We recommend you to use this feature judiciously. For example, you may want to make sure the {\ttfamily Set()} and {\ttfamily Clear()} calls are right next to the code that uses your mock.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md151}{}\doxysubsection{\texorpdfstring{Setting the Default Actions for a Mock Method}{Setting the Default Actions for a Mock Method}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md151}
...
Note that both {\ttfamily ON\+\_\+\+CALL} and {\ttfamily EXPECT\+\_\+\+CALL} have the same "{}later statements take precedence"{} rule, but they don\textquotesingle{}t interact. That is, {\ttfamily EXPECT\+\_\+\+CALL}s have their own precedence order distinct from the {\ttfamily ON\+\_\+\+CALL} precedence order.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_FunctionsAsActions}{}\doxysubsection{\texorpdfstring{Using Functions/\+\+Methods/\+\+Functors/\+\+Lambdas as Actions}{Using Functions/\+\+Methods/\+\+Functors/\+\+Lambdas as Actions}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_FunctionsAsActions}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{using\ }::testing::\_;\ \textcolor{keyword}{using\ }::testing::Invoke;}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{keyword}{class\ }MockFoo\ :\ \textcolor{keyword}{public}\ Foo\ \{}
\DoxyCodeLine{\ \textcolor{keyword}{public}:}
...
\end{DoxyItemize}\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md152}{}\doxysubsection{\texorpdfstring{Using Functions with Extra Info as Actions}{Using Functions with Extra Info as Actions}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md152}
...
\end{DoxyCode}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md153}{}\doxysubsection{\texorpdfstring{Invoking a Function/\+\+Method/\+\+Functor/\+\+Lambda/\+\+Callback Without Arguments}{Invoking a Function/\+\+Method/\+\+Functor/\+\+Lambda/\+\+Callback Without Arguments}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md153}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{using\ }::testing::\_;}
\DoxyCodeLine{\textcolor{keyword}{using\ }::testing::InvokeWithoutArgs;}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{keyword}{class\ }MockFoo\ :\ \textcolor{keyword}{public}\ Foo\ \{}
\DoxyCodeLine{\ \textcolor{keyword}{public}:}
...
\end{DoxyItemize}\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md154}{}\doxysubsection{\texorpdfstring{Invoking an Argument of the Mock Function}{Invoking an Argument of the Mock Function}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md154}
...
\end{DoxyCode}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md155}{}\doxysubsection{\texorpdfstring{Ignoring an Action\textquotesingle{}s Result}{Ignoring an Action\textquotesingle{}s Result}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md155}
...
\DoxyCodeLine{\textcolor{keyword}{using\ }::testing::\_;}
\DoxyCodeLine{\textcolor{keyword}{using\ }::testing::DoAll;}
\DoxyCodeLine{\textcolor{keyword}{using\ }::testing::IgnoreResult;}
\DoxyCodeLine{\textcolor{keyword}{using\ }::testing::Return;}
\DoxyCodeLine{}
...
Note that you {\bfseries{cannot}} use {\ttfamily Ignore\+Result()} on an action that already returns {\ttfamily void}. Doing so will lead to ugly compiler errors.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_SelectingArgs}{}\doxysubsection{\texorpdfstring{Selecting an Action\textquotesingle{}s Arguments}{Selecting an Action\textquotesingle{}s Arguments}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_SelectingArgs}
...
\DoxyCodeLine{\textcolor{keyword}{using\ }::testing::\_;}
\DoxyCodeLine{\textcolor{keyword}{using\ }::testing::Invoke;}
\DoxyCodeLine{\textcolor{keyword}{using\ }::testing::WithArgs;}
\DoxyCodeLine{...}
\DoxyCodeLine{\ \ EXPECT\_CALL(mock,\ Foo)}
...
\end{DoxyItemize}\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md156}{}\doxysubsection{\texorpdfstring{Ignoring Arguments in Action Functions}{Ignoring Arguments in Action Functions}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md156}
The \doxysectlink{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_SelectingArgs}{selecting-\/an-\/action\textquotesingle{}s-\/arguments}{2} recipe showed us one way to make a mock function and an action with incompatible argument lists fit together. The downside is that wrapping the action in {\ttfamily With\+Args\texorpdfstring{$<$}{<}...\texorpdfstring{$>$}{>}()} can get tedious for people writing the tests.
...
\DoxyCodeLine{\textcolor{keyword}{using\ }::testing::\_;}
\DoxyCodeLine{\textcolor{keyword}{using\ }::testing::Invoke;}
\DoxyCodeLine{\textcolor{keyword}{using\ }::testing::Unused;}
\DoxyCodeLine{}
...
\end{DoxyCode}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md157}{}\doxysubsection{\texorpdfstring{Sharing Actions}{Sharing Actions}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md157}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{using\ }::\doxymbox{\hyperlink{classtesting_1_1_action}{testing::Action}};}
\DoxyCodeLine{\textcolor{keyword}{using\ }::testing::DoAll;}
\DoxyCodeLine{\textcolor{keyword}{using\ }::testing::Return;}
\DoxyCodeLine{\textcolor{keyword}{using\ }::testing::SetArgPointee;}
\DoxyCodeLine{...}
\DoxyCodeLine{\ \ \doxymbox{\hyperlink{class_action}{Action}}<bool(\textcolor{keywordtype}{int}*)>\ set\_flag\ =\ DoAll(SetArgPointee<0>(5),}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ Return(\textcolor{keyword}{true}));}
...
\DoxyCodeLine{\textcolor{keyword}{using\ }::\doxymbox{\hyperlink{classtesting_1_1_action}{testing::Action}};}
\DoxyCodeLine{...}
\DoxyCodeLine{\ \ \doxymbox{\hyperlink{class_action}{Action}}<int()>\ increment\ =\ IncrementCounter(0);}
\DoxyCodeLine{\ \ EXPECT\_CALL(foo,\ DoThis())}
...
\end{DoxyCode}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md158}{}\doxysubsection{\texorpdfstring{Testing Asynchronous Behavior}{Testing Asynchronous Behavior}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md158}
...
\{:\+ .callout .note\} Note:\+ this example has a downside:\+ namely, if the expectation is not satisfied, our test will run forever. It will eventually time-\/out and fail, but it will take longer and be slightly harder to debug. To alleviate this problem, you can use {\ttfamily Wait\+For\+Notification\+With\+Timeout(ms)} instead of {\ttfamily Wait\+For\+Notification()}.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md159}{}\doxysection{\texorpdfstring{Misc Recipes on Using g\+Mock}{Misc Recipes on Using g\+Mock}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md159}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md160}{}\doxysubsection{\texorpdfstring{Mocking Methods That Use Move-\/\+Only Types}{Mocking Methods That Use Move-\/\+Only Types}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md160}
...
Mocking a method that takes and/\+or returns move-\/only types presents some challenges, but nothing insurmountable. This recipe shows you how you can do it. Note that the support for move-\/only method arguments was only introduced to g\+Mock in April 2017; in older code, you may find more complex \doxysectlink{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_LegacyMoveOnly}{workarounds}{3} for lack of this feature.
...
If you are not happy with the default action, you can tweak it as usual; see \doxysectlink{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cheat__sheet_OnCall}{Setting Default Actions}{1}.
...
A few actions (e.\+g. {\ttfamily Do\+All}) copy their arguments internally, so they can never work with non-\/copyable objects; you\textquotesingle{}ll have to use functors instead.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_LegacyMoveOnly}{}\doxysubsubsection{\texorpdfstring{Legacy workarounds for move-\/only types}{Legacy workarounds for move-\/only types}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_LegacyMoveOnly}
...
\end{DoxyCode}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md161}{}\doxysubsection{\texorpdfstring{Making the Compilation Faster}{Making the Compilation Faster}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md161}
...
\end{DoxyCode}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md162}{}\doxysubsection{\texorpdfstring{Forcing a Verification}{Forcing a Verification}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md162}
...
\DoxyCodeLine{\ \ \textcolor{keyword}{using\ }::testing::Mock;}
\DoxyCodeLine{}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{using\ }::testing::MockFunction;}
\DoxyCodeLine{}
...
The expectation spec says that the first {\ttfamily Bar("{}a"{})} call must happen before checkpoint "{}1"{}, the second {\ttfamily Bar("{}a"{})} call must happen after checkpoint "{}2"{}, and nothing should happen between the two checkpoints. The explicit checkpoints make it clear which {\ttfamily Bar("{}a"{})} is called by which call to {\ttfamily Foo()}.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md163}{}\doxysubsection{\texorpdfstring{Mocking Destructors}{Mocking Destructors}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md163}
Sometimes you want to make sure a mock object is destructed at the right time, e.\+g. after {\ttfamily bar-\/\texorpdfstring{$>$}{>}A()} is called but before {\ttfamily bar-\/\texorpdfstring{$>$}{>}B()} is called. We already know that you can specify constraints on the \doxysectlink{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__for__dummies_OrderedCalls}{order}{2} of mock function calls, so all we need to do is to mock the destructor of the mock function.
...
And that\textquotesingle{}s that.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_UsingThreads}{}\doxysubsection{\texorpdfstring{Using g\+Mock and Threads}{Using g\+Mock and Threads}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_UsingThreads}
...
Also, remember that {\ttfamily Default\+Value\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}} is a global resource that potentially affects {\itshape all} living mock objects in your program. Naturally, you won\textquotesingle{}t want to mess with it from multiple threads or when there still are mocks in action.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md164}{}\doxysubsection{\texorpdfstring{Controlling How Much Information g\+Mock Prints}{Controlling How Much Information g\+Mock Prints}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md164}
...
Now, judiciously use the right flag to enable g\+Mock serve you better!\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md165}{}\doxysubsection{\texorpdfstring{Gaining Super Vision into Mock Calls}{Gaining Super Vision into Mock Calls}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md165}
...
If you are interested in the mock call trace but not the stack traces, you can combine {\ttfamily -\/-\/gmock\+\_\+verbose=info} with {\ttfamily -\/-\/gtest\+\_\+stack\+\_\+trace\+\_\+depth=0} on the test command line.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md166}{}\doxysubsection{\texorpdfstring{Running Tests in Emacs}{Running Tests in Emacs}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md166}
If you build and run your tests in Emacs using the {\ttfamily M-\/x google-\/compile} command (as many googletest users do), the source file locations of g\+Mock and googletest errors will be highlighted. Just press {\ttfamily \texorpdfstring{$<$}{<}Enter\texorpdfstring{$>$}{>}} on one of them and you\textquotesingle{}ll be taken to the offending line. Or, you can just type \`{}\+C-\/x\`{}\`{} to jump to the next error.
...
Then you can type {\ttfamily M-\/m} to start a build (if you want to run the test as well, just make sure {\ttfamily foo\+\_\+test.\+run} or {\ttfamily runtests} is in the build command you supply after typing {\ttfamily M-\/m}), or {\ttfamily M-\/up}/\+{\ttfamily M-\/down} to move back and forth between errors.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md167}{}\doxysection{\texorpdfstring{Extending g\+Mock}{Extending g\+Mock}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md167}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_NewMatchers}{}\doxysubsection{\texorpdfstring{Writing New Matchers Quickly}{Writing New Matchers Quickly}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_NewMatchers}
\{:\+ .callout .warning\} WARNING:\+ g\+Mock does not guarantee when or how many times a matcher will be invoked. Therefore, all matchers must be functionally pure. See \doxysectlink{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_PureMatchers}{this section}{2} for more details.
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{using\ }::testing::PrintToString;}
...
\DoxyCodeLine{\};}
\DoxyCodeLine{}
\DoxyCodeLine{\doxymbox{\hyperlink{class_matcher}{Matcher<int>}}\ DivisibleBy7()\ \{}
...
\{:\+ .callout .tip\} Tip:\+ for convenience, {\ttfamily Match\+And\+Explain()} can take a {\ttfamily Match\+Result\+Listener\texorpdfstring{$\ast$}{*}} instead of {\ttfamily std::\+ostream\texorpdfstring{$\ast$}{*}}.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md170}{}\doxysubsection{\texorpdfstring{Writing New Polymorphic Matchers}{Writing New Polymorphic Matchers}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md170}
...
\end{DoxyCode}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md171}{}\doxysubsection{\texorpdfstring{Legacy Matcher Implementation}{Legacy Matcher Implementation}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md171}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{using\ }::testing::MakePolymorphicMatcher;}
\DoxyCodeLine{\textcolor{keyword}{using\ }::testing::MatchResultListener;}
\DoxyCodeLine{\textcolor{keyword}{using\ }::testing::PolymorphicMatcher;}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{keyword}{class\ }NotNullMatcher\ \{}
\DoxyCodeLine{\ \textcolor{keyword}{public}:}
...
Like in a monomorphic matcher, you may explain the match result by streaming additional information to the {\ttfamily listener} argument in {\ttfamily Match\+And\+Explain()}.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md172}{}\doxysubsection{\texorpdfstring{Writing New Cardinalities}{Writing New Cardinalities}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md172}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{using\ }::testing::Cardinality;}
\DoxyCodeLine{\textcolor{keyword}{using\ }::testing::CardinalityInterface;}
\DoxyCodeLine{\textcolor{keyword}{using\ }::testing::MakeCardinality;}
\DoxyCodeLine{}
...
\end{DoxyCode}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_QuickNewActions}{}\doxysubsection{\texorpdfstring{Writing New Actions}{Writing New Actions}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_QuickNewActions}
...
More generally, to use with a mock function whose signature is {\ttfamily R(\+Args...)} the object can be anything convertible to {\ttfamily Once\+Action\texorpdfstring{$<$}{<}R(\+Args...)\texorpdfstring{$>$}{>}} or {\ttfamily \doxylink{class_action}{Action}\texorpdfstring{$<$}{<}R(\+Args...)}\texorpdfstring{$>$}{>}. The difference between the two is that {\ttfamily Once\+Action} has weaker requirements ({\ttfamily \doxylink{class_action}{Action}} requires a copy-\/constructible input that can be called repeatedly whereas {\ttfamily Once\+Action} requires only move-\/constructible and supports {\ttfamily \&\&}-\/qualified call operators), but can be used only with {\ttfamily Will\+Once}. {\ttfamily Once\+Action} is typically relevant only when supporting move-\/only types or actions that want a type-\/system guarantee that they will be called at most once.

Typically the {\ttfamily Once\+Action} and {\ttfamily \doxylink{class_action}{Action}} templates need not be referenced directly in your actions:\+ a struct or class with a call operator is sufficient, as in the examples above. But fancier polymorphic actions that need to know the specific return type of the mock function can define templated conversion operators to make that possible. See {\ttfamily \doxylink{gmock-actions_8h_source}{gmock-\/actions.\+h}} for examples.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md173}{}\doxysubsubsection{\texorpdfstring{Legacy macro-\/based Actions}{Legacy macro-\/based Actions}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md173}
...
\begin{DoxyTable}{2}{}{}{1}
\SetCell{bg=\tableheadbgcolor,font=\bfseries}{\ttfamily arg\+K\+\_\+type}  &\SetCell{bg=\tableheadbgcolor,font=\bfseries}The type of the K-\/th (0-\/based) argument of the mock function  \\
...
\begin{DoxyTable}{2}{}{}{1}
\SetCell{c,bg=\tableheadbgcolor,font=\bfseries}Pre-\/defined Symbol  &\SetCell{c,bg=\tableheadbgcolor,font=\bfseries}Is Bound To  \\
{\ttfamily arg0}  &the value of {\ttfamily flag}  \\
{\ttfamily arg0\+\_\+type}  &the type {\ttfamily bool}  \\
{\ttfamily arg1}  &the value of {\ttfamily ptr}  \\
{\ttfamily arg1\+\_\+type}  &the type {\ttfamily int\texorpdfstring{$\ast$}{*}}  \\
{\ttfamily args}  &the tuple {\ttfamily (flag, ptr)}  \\
{\ttfamily args\+\_\+type}  &the type {\ttfamily std::\+tuple\texorpdfstring{$<$}{<}bool, int\texorpdfstring{$\ast$}{*}\texorpdfstring{$>$}{>}}  \\
{\ttfamily return\+\_\+type}  &the type {\ttfamily int}  \\
{\ttfamily function\+\_\+type}  &the type {\ttfamily int(bool, int\texorpdfstring{$\ast$}{*})}  \\
\end{DoxyTable}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md174}{}\doxysubsubsection{\texorpdfstring{Legacy macro-\/based parameterized Actions}{Legacy macro-\/based parameterized Actions}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md174}
...
\end{DoxyCode}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md175}{}\doxysubsection{\texorpdfstring{Restricting the Type of an Argument or Parameter in an ACTION}{Restricting the Type of an Argument or Parameter in an ACTION}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md175}
...
where {\ttfamily Static\+Assert\+Type\+Eq} is a compile-\/time assertion in googletest that verifies two types are the same.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md176}{}\doxysubsection{\texorpdfstring{Writing New Action Templates Quickly}{Writing New Action Templates Quickly}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md176}
...
defines an action template that takes {\itshape m} explicit template parameters and {\itshape n} value parameters, where {\itshape m} is in \+[1, 10]\+ and {\itshape n} is in \+[0, 10]\+. {\ttfamily name\+\_\+i} is the name of the {\itshape i}-\/th template parameter, and {\ttfamily kind\+\_\+i} specifies whether it\textquotesingle{}s a {\ttfamily typename}, an integral constant, or a template. {\ttfamily p\+\_\+i} is the name of the {\itshape i}-\/th value parameter.
...
Are we using a single-\/template-\/parameter action where {\ttfamily bool} refers to the type of {\ttfamily x}, or a two-\/template-\/parameter action where the compiler is asked to infer the type of {\ttfamily x}?\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md177}{}\doxysubsection{\texorpdfstring{Using the ACTION Object\textquotesingle{}s Type}{Using the ACTION Object\textquotesingle{}s Type}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md177}
...
\begin{DoxyTable}{3}{}{}{1}
\SetCell{c,bg=\tableheadbgcolor,font=\bfseries}Given Definition  &\SetCell{c,bg=\tableheadbgcolor,font=\bfseries}Expression  &\SetCell{c,bg=\tableheadbgcolor,font=\bfseries}Has Type  \\
{\ttfamily ACTION(\+Foo)}  &{\ttfamily Foo()}  &{\ttfamily Foo\+Action}  \\
{\ttfamily ACTION\+\_\+\+TEMPLATE(Foo, HAS\+\_\+m\+\_\+\+TEMPLATE\+\_\+\+PARAMS(...), AND\+\_\+0\+\_\+\+VALUE\+\_\+\+PARAMS())}  &{\ttfamily Foo\texorpdfstring{$<$}{<}t1, ..., t\+\_\+m\texorpdfstring{$>$}{>}()}  &{\ttfamily Foo\+Action\texorpdfstring{$<$}{<}t1, ..., t\+\_\+m\texorpdfstring{$>$}{>}}  \\
{\ttfamily ACTION\+\_\+\+P(\+Bar, param)}  &{\ttfamily Bar(int\+\_\+value)}  &{\ttfamily Bar\+ActionP\texorpdfstring{$<$}{<}int\texorpdfstring{$>$}{>}}  \\
{\ttfamily ACTION\+\_\+\+TEMPLATE(Bar, HAS\+\_\+m\+\_\+\+TEMPLATE\+\_\+\+PARAMS(...), AND\+\_\+1\+\_\+\+VALUE\+\_\+\+PARAMS(p1))}  &{\ttfamily Bar\texorpdfstring{$<$}{<}t1, ..., t\+\_\+m\texorpdfstring{$>$}{>}(int\+\_\+value)}  &{\ttfamily Bar\+ActionP\texorpdfstring{$<$}{<}t1, ..., t\+\_\+m, int\texorpdfstring{$>$}{>}}  \\
{\ttfamily ACTION\+\_\+\+P2(\+Baz, p1, p2)}  &{\ttfamily Baz(bool\+\_\+value, int\+\_\+value)}  &{\ttfamily Baz\+Action\+P2\texorpdfstring{$<$}{<}bool, int\texorpdfstring{$>$}{>}}  \\
{\ttfamily ACTION\+\_\+\+TEMPLATE(Baz, HAS\+\_\+m\+\_\+\+TEMPLATE\+\_\+\+PARAMS(...), AND\+\_\+2\+\_\+\+VALUE\+\_\+\+PARAMS(p1, p2))}  &{\ttfamily Baz\texorpdfstring{$<$}{<}t1, ..., t\+\_\+m\texorpdfstring{$>$}{>}(bool\+\_\+value, int\+\_\+value)}  &{\ttfamily Baz\+Action\+P2\texorpdfstring{$<$}{<}t1, ..., t\+\_\+m, bool, int\texorpdfstring{$>$}{>}}  \\
...  &...  &...  \\
\end{DoxyTable}


Note that we have to pick different suffixes ({\ttfamily \doxylink{class_action}{Action}}, {\ttfamily ActionP}, {\ttfamily Action\+P2}, and etc) for actions with different numbers of value parameters, or the action definitions cannot be overloaded on the number of them.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_NewMonoActions}{}\doxysubsection{\texorpdfstring{Writing New Monomorphic Actions}{Writing New Monomorphic Actions}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_NewMonoActions}
...
\DoxyCodeLine{\textcolor{keyword}{using\ }::testing::\_;}
\DoxyCodeLine{\textcolor{keyword}{using\ }::\doxymbox{\hyperlink{classtesting_1_1_action}{testing::Action}};}
\DoxyCodeLine{\textcolor{keyword}{using\ }::\doxymbox{\hyperlink{classtesting_1_1_action_interface}{testing::ActionInterface}};}
\DoxyCodeLine{\textcolor{keyword}{using\ }::testing::MakeAction;}
\DoxyCodeLine{}
...
\DoxyCodeLine{\};}
\DoxyCodeLine{}
\DoxyCodeLine{\doxymbox{\hyperlink{class_action}{Action<IncrementMethod>}}\ IncrementArgument()\ \{}
...
\end{DoxyCode}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_NewPolyActions}{}\doxysubsection{\texorpdfstring{Writing New Polymorphic Actions}{Writing New Polymorphic Actions}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_NewPolyActions}
...
\DoxyCodeLine{\doxymbox{\hyperlink{classtesting_1_1_polymorphic_action}{PolymorphicAction<Impl>}}\ MakePolymorphicAction(\textcolor{keyword}{const}\ Impl\&\ impl);}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{using\ }::testing::MakePolymorphicAction;}
\DoxyCodeLine{\textcolor{keyword}{using\ }::\doxymbox{\hyperlink{classtesting_1_1_polymorphic_action}{testing::PolymorphicAction}};}
\DoxyCodeLine{}
...
\end{DoxyCode}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md178}{}\doxysubsection{\texorpdfstring{Teaching g\+Mock How to Print Your Values}{Teaching g\+Mock How to Print Your Values}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md178}
...
This printer knows how to print built-\/in C++ types, native arrays, STL containers, and any type that supports the {\ttfamily \texorpdfstring{$<$}{<}\texorpdfstring{$<$}{<}} operator. For other types, it prints the raw bytes in the value and hopes that you the user can figure it out. \href{advanced.md\#teaching-googletest-how-to-print-your-values}{\texttt{The Google\+Test advanced guide}} explains how to extend the printer to do a better job at printing your particular type than to dump the bytes.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md179}{}\doxysection{\texorpdfstring{Useful Mocks Created Using g\+Mock}{Useful Mocks Created Using g\+Mock}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md179}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_MockFunction}{}\doxysubsection{\texorpdfstring{Mock std::\+function}{Mock std::\+function}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_MockFunction}
