...
\hypertarget{googletest-port-test_8cc_source}{}\label{googletest-port-test_8cc_source}\index{cmake-\/build-\/debug/\_deps/googletest-\/src/googletest/test/googletest-\/port-\/test.cc@{cmake-\/build-\/debug/\_deps/googletest-\/src/googletest/test/googletest-\/port-\/test.cc}}
...
\DoxyCodeLine{00120\ \}}
\DoxyCodeLine{00121\ }
\DoxyCodeLine{00122\ \textcolor{keyword}{class\ }Castable\ \{}
\DoxyCodeLine{00123\ \ \textcolor{keyword}{public}:}
\DoxyCodeLine{00124\ \ \ \textcolor{keyword}{explicit}\ Castable(\textcolor{keywordtype}{bool}*\ converted)\ :\ converted\_(converted)\ \{\}}
...
\DoxyCodeLine{00136\ \ \ \doxymbox{\hyperlink{classtesting_1_1internal_1_1_castable}{Castable}}\ castable(\&converted);}
\DoxyCodeLine{00137\ \ \ Base\ base\ =\ ::testing::internal::ImplicitCast\_<Base>(castable);}
\DoxyCodeLine{00138\ \ \ EXPECT\_TRUE(converted);}
\DoxyCodeLine{00139\ \}}
\DoxyCodeLine{00140\ }
\DoxyCodeLine{00141\ \textcolor{keyword}{class\ }ConstCastable\ \{}
\DoxyCodeLine{00142\ \ \textcolor{keyword}{public}:}
\DoxyCodeLine{00143\ \ \ \textcolor{keyword}{explicit}\ ConstCastable(\textcolor{keywordtype}{bool}*\ converted)\ :\ converted\_(converted)\ \{\}}
...
\DoxyCodeLine{00155\ \ \ \textcolor{keyword}{const}\ \doxymbox{\hyperlink{classtesting_1_1internal_1_1_const_castable}{ConstCastable}}\ const\_castable(\&converted);}
...
\DoxyCodeLine{00158\ \}}
\DoxyCodeLine{00159\ }
\DoxyCodeLine{00160\ \textcolor{keyword}{class\ }ConstAndNonConstCastable\ \{}
\DoxyCodeLine{00161\ \ \textcolor{keyword}{public}:}
\DoxyCodeLine{00162\ \ \ ConstAndNonConstCastable(\textcolor{keywordtype}{bool}*\ converted,\ \textcolor{keywordtype}{bool}*\ const\_converted)}
...
\DoxyCodeLine{00181\ \ \ \doxymbox{\hyperlink{classtesting_1_1internal_1_1_const_and_non_const_castable}{ConstAndNonConstCastable}}\ castable(\&converted,\ \&const\_converted);}
...
\DoxyCodeLine{00188\ \ \ \textcolor{keyword}{const}\ \doxymbox{\hyperlink{classtesting_1_1internal_1_1_const_and_non_const_castable}{ConstAndNonConstCastable}}\ const\_castable(\&converted,\ \&const\_converted);}
...
\DoxyCodeLine{00192\ \}}
\DoxyCodeLine{00193\ }
\DoxyCodeLine{00194\ \textcolor{keyword}{class\ }To\ \{}
\DoxyCodeLine{00195\ \ \textcolor{keyword}{public}:}
\DoxyCodeLine{00196\ \ \ To(\textcolor{keywordtype}{bool}*\ converted)\ \{\ *converted\ =\ \textcolor{keyword}{true};\ \}\ \ \textcolor{comment}{//\ NOLINT}}
\DoxyCodeLine{00197\ \};}
\DoxyCodeLine{00198\ }
...
\DoxyCodeLine{00201\ \ \ \doxymbox{\hyperlink{classtesting_1_1internal_1_1_to}{To}}\ to\ =\ ::testing::internal::ImplicitCast\_<To>(\&converted);}
...
\DoxyCodeLine{00402\ \textcolor{keyword}{class\ }RETest\ :\ \textcolor{keyword}{public}\ ::testing::Test\ \{\};}
\DoxyCodeLine{00403\ }
...
\DoxyCodeLine{00406\ \textcolor{keyword}{typedef}\ testing::Types<\ ::std::string,\ const\ char*>\ StringTypes;}
\DoxyCodeLine{00407\ }
...
\DoxyCodeLine{00412\ \ \ \textcolor{keyword}{const}\ \doxymbox{\hyperlink{classtesting_1_1internal_1_1_r_e}{RE}}\ empty(TypeParam(\textcolor{stringliteral}{"{}"{}}));}
\DoxyCodeLine{00413\ \ \ EXPECT\_STREQ(\textcolor{stringliteral}{"{}"{}},\ empty.pattern());}
\DoxyCodeLine{00414\ }
\DoxyCodeLine{00415\ \ \ \textcolor{keyword}{const}\ \doxymbox{\hyperlink{classtesting_1_1internal_1_1_r_e}{RE}}\ simple(TypeParam(\textcolor{stringliteral}{"{}hello"{}}));}
\DoxyCodeLine{00416\ \ \ EXPECT\_STREQ(\textcolor{stringliteral}{"{}hello"{}},\ simple.pattern());}
\DoxyCodeLine{00417\ }
\DoxyCodeLine{00418\ \ \ \textcolor{keyword}{const}\ \doxymbox{\hyperlink{classtesting_1_1internal_1_1_r_e}{RE}}\ normal(TypeParam(\textcolor{stringliteral}{"{}.*(\(\backslash\)\(\backslash\)w+)"{}}));}
...
\DoxyCodeLine{00425\ \ \ \ \ \ \ \{\ \textcolor{keyword}{const}\ \doxymbox{\hyperlink{classtesting_1_1internal_1_1_r_e}{RE}}\ invalid(TypeParam(\textcolor{stringliteral}{"{}?"{}}));\ \},}
...
\DoxyCodeLine{00431\ \ \ \textcolor{keyword}{const}\ \doxymbox{\hyperlink{classtesting_1_1internal_1_1_r_e}{RE}}\ empty(TypeParam(\textcolor{stringliteral}{"{}"{}}));}
...
\DoxyCodeLine{00434\ }
\DoxyCodeLine{00435\ \ \ \textcolor{keyword}{const}\ \doxymbox{\hyperlink{classtesting_1_1internal_1_1_r_e}{RE}}\ re(TypeParam(\textcolor{stringliteral}{"{}a.*z"{}}));}
...
\DoxyCodeLine{00444\ \ \ \textcolor{keyword}{const}\ \doxymbox{\hyperlink{classtesting_1_1internal_1_1_r_e}{RE}}\ empty(TypeParam(\textcolor{stringliteral}{"{}"{}}));}
...
\DoxyCodeLine{00447\ }
\DoxyCodeLine{00448\ \ \ \textcolor{keyword}{const}\ \doxymbox{\hyperlink{classtesting_1_1internal_1_1_r_e}{RE}}\ re(TypeParam(\textcolor{stringliteral}{"{}a.*z"{}}));}
...
\DoxyCodeLine{00867\ \ \ \textcolor{keyword}{const}\ \doxymbox{\hyperlink{classtesting_1_1internal_1_1_r_e}{RE}}\ empty(\textcolor{stringliteral}{"{}"{}});}
\DoxyCodeLine{00868\ \ \ EXPECT\_STREQ(\textcolor{stringliteral}{"{}"{}},\ empty.pattern());}
\DoxyCodeLine{00869\ }
\DoxyCodeLine{00870\ \ \ \textcolor{keyword}{const}\ \doxymbox{\hyperlink{classtesting_1_1internal_1_1_r_e}{RE}}\ simple(\textcolor{stringliteral}{"{}hello"{}});}
...
\DoxyCodeLine{00876\ \ \ EXPECT\_NONFATAL\_FAILURE(\{\ \textcolor{keyword}{const}\ \doxymbox{\hyperlink{classtesting_1_1internal_1_1_r_e}{RE}}\ normal(NULL);\ \},}
\DoxyCodeLine{00877\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{stringliteral}{"{}NULL\ is\ not\ a\ valid\ simple\ regular\ expression"{}});}
\DoxyCodeLine{00878\ }
\DoxyCodeLine{00879\ \ \ EXPECT\_NONFATAL\_FAILURE(\{\ \textcolor{keyword}{const}\ \doxymbox{\hyperlink{classtesting_1_1internal_1_1_r_e}{RE}}\ normal(\textcolor{stringliteral}{"{}.*(\(\backslash\)\(\backslash\)w+"{}});\ \},}
\DoxyCodeLine{00880\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{stringliteral}{"{}'('\ is\ unsupported"{}});}
\DoxyCodeLine{00881\ }
\DoxyCodeLine{00882\ \ \ EXPECT\_NONFATAL\_FAILURE(\{\ \textcolor{keyword}{const}\ \doxymbox{\hyperlink{classtesting_1_1internal_1_1_r_e}{RE}}\ invalid(\textcolor{stringliteral}{"{}\string^?"{}});\ \},}
...
\DoxyCodeLine{00888\ \ \ \textcolor{keyword}{const}\ \doxymbox{\hyperlink{classtesting_1_1internal_1_1_r_e}{RE}}\ empty(\textcolor{stringliteral}{"{}"{}});}
...
\DoxyCodeLine{00891\ }
\DoxyCodeLine{00892\ \ \ \textcolor{keyword}{const}\ \doxymbox{\hyperlink{classtesting_1_1internal_1_1_r_e}{RE}}\ re1(\textcolor{stringliteral}{"{}a"{}});}
\DoxyCodeLine{00893\ \ \ EXPECT\_TRUE(RE::FullMatch(\textcolor{stringliteral}{"{}a"{}},\ re1));}
\DoxyCodeLine{00894\ }
\DoxyCodeLine{00895\ \ \ \textcolor{keyword}{const}\ \doxymbox{\hyperlink{classtesting_1_1internal_1_1_r_e}{RE}}\ re(\textcolor{stringliteral}{"{}a.*z"{}});}
...
\DoxyCodeLine{00904\ \ \ \textcolor{keyword}{const}\ \doxymbox{\hyperlink{classtesting_1_1internal_1_1_r_e}{RE}}\ empty(\textcolor{stringliteral}{"{}"{}});}
...
\DoxyCodeLine{00907\ }
\DoxyCodeLine{00908\ \ \ \textcolor{keyword}{const}\ \doxymbox{\hyperlink{classtesting_1_1internal_1_1_r_e}{RE}}\ re(\textcolor{stringliteral}{"{}a.*z"{}});}
...
\DoxyCodeLine{00963\ \ \ \doxymbox{\hyperlink{classtesting_1_1internal_1_1_thread_local}{ThreadLocal<int>}}\ t1;}
\DoxyCodeLine{00964\ \ \ EXPECT\_EQ(0,\ t1.get());}
\DoxyCodeLine{00965\ }
\DoxyCodeLine{00966\ \ \ \doxymbox{\hyperlink{classtesting_1_1internal_1_1_thread_local}{ThreadLocal<void*>}}\ t2;}
...
\DoxyCodeLine{00971\ \ \ \doxymbox{\hyperlink{classtesting_1_1internal_1_1_thread_local}{ThreadLocal<int>}}\ t1(123);}
\DoxyCodeLine{00972\ \ \ EXPECT\_EQ(123,\ t1.get());}
\DoxyCodeLine{00973\ }
\DoxyCodeLine{00974\ \ \ \textcolor{keywordtype}{int}\ i\ =\ 0;}
\DoxyCodeLine{00975\ \ \ \doxymbox{\hyperlink{classtesting_1_1internal_1_1_thread_local}{ThreadLocal<int*>}}\ t2(\&i);}
\DoxyCodeLine{00976\ \ \ EXPECT\_EQ(\&i,\ t2.get());}
\DoxyCodeLine{00977\ \}}
\DoxyCodeLine{00978\ }
\DoxyCodeLine{00979\ \textcolor{keyword}{class\ }NoDefaultContructor\ \{}
\DoxyCodeLine{00980\ \ \textcolor{keyword}{public}:}
\DoxyCodeLine{00981\ \ \ \textcolor{keyword}{explicit}\ NoDefaultContructor(\textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*)\ \{\}}
\DoxyCodeLine{00982\ \ \ NoDefaultContructor(\textcolor{keyword}{const}\ NoDefaultContructor\&)\ \{\}}
\DoxyCodeLine{00983\ \};}
\DoxyCodeLine{00984\ }
\DoxyCodeLine{00985\ TEST(ThreadLocalTest,\ ValueDefaultContructorIsNotRequiredForParamVersion)\ \{}
\DoxyCodeLine{00986\ \ \ \doxymbox{\hyperlink{classtesting_1_1internal_1_1_thread_local}{ThreadLocal<NoDefaultContructor>}}\ bar(\doxymbox{\hyperlink{classtesting_1_1internal_1_1_no_default_contructor}{NoDefaultContructor}}(\textcolor{stringliteral}{"{}foo"{}}));}
...
\DoxyCodeLine{01026\ \ \ \ \ \ \ \{}
\DoxyCodeLine{01027\ \ \ \ \ \ \ \ \ \doxymbox{\hyperlink{classtesting_1_1internal_1_1_mutex}{Mutex}}\ m;}
...
\DoxyCodeLine{01035\ \ \ \doxymbox{\hyperlink{classtesting_1_1internal_1_1_mutex}{Mutex}}\ m;}
...
\DoxyCodeLine{01093\ \ \ \doxymbox{\hyperlink{classtesting_1_1internal_1_1_mutex}{Mutex}}\ mutex;}
...
\DoxyCodeLine{01125\ \ \ \ \ pair<\doxymbox{\hyperlink{classtesting_1_1internal_1_1_thread_local}{ThreadLocal<std::string>}}*,\ std::string*>\ param)\ \{}
...
\DoxyCodeLine{01130\ \ \ \doxymbox{\hyperlink{classtesting_1_1internal_1_1_thread_local}{ThreadLocal<std::string>}}\ thread\_local\_string(\textcolor{stringliteral}{"{}foo"{}});}
...
\DoxyCodeLine{01211\ \};}
\DoxyCodeLine{01212\ }
\DoxyCodeLine{01213\ \textcolor{keyword}{typedef}\ \doxymbox{\hyperlink{classtesting_1_1internal_1_1_thread_local}{ThreadLocal<DestructorTracker>}}*\ ThreadParam;}
\DoxyCodeLine{01214\ }
...
\DoxyCodeLine{01223\ }
\DoxyCodeLine{01224\ \ \ \{}
\DoxyCodeLine{01225\ \ \ \ \ \doxymbox{\hyperlink{classtesting_1_1internal_1_1_thread_local}{ThreadLocal<DestructorTracker>}}\ thread\_local\_tracker;}
...
\DoxyCodeLine{01245\ }
\DoxyCodeLine{01246\ \ \ \{}
\DoxyCodeLine{01247\ \ \ \ \ \doxymbox{\hyperlink{classtesting_1_1internal_1_1_thread_local}{ThreadLocal<DestructorTracker>}}\ thread\_local\_tracker;}
...
\DoxyCodeLine{01268\ \ \ \doxymbox{\hyperlink{classtesting_1_1internal_1_1_thread_local}{ThreadLocal<std::string>}}\ thread\_local\_string;}
