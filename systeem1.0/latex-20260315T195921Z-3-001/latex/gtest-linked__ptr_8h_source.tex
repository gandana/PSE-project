...
\DoxyCodeLine{00089\ \textcolor{keyword}{class\ }\doxymbox{\hyperlink{classtesting_1_1internal_1_1linked__ptr__internal}{linked\_ptr\_internal}}\ \{}
...
\DoxyCodeLine{00108\ \ \ \textcolor{keywordtype}{void}\ join(\doxymbox{\hyperlink{classtesting_1_1internal_1_1linked__ptr__internal}{linked\_ptr\_internal}}\ \textcolor{keyword}{const}*\ ptr)}
\DoxyCodeLine{00109\ \ \ \ \ \ \ GTEST\_LOCK\_EXCLUDED\_(g\_linked\_ptr\_mutex)\ \{}
\DoxyCodeLine{00110\ \ \ \ \ MutexLock\ lock(\&g\_linked\_ptr\_mutex);}
\DoxyCodeLine{00111\ }
\DoxyCodeLine{00112\ \ \ \ \ \doxymbox{\hyperlink{classtesting_1_1internal_1_1linked__ptr__internal}{linked\_ptr\_internal}}\ \textcolor{keyword}{const}*\ p\ =\ ptr;}
\DoxyCodeLine{00113\ \ \ \ \ \textcolor{keywordflow}{while}\ (p-\/>next\_\ !=\ ptr)\ p\ =\ p-\/>next\_;}
\DoxyCodeLine{00114\ \ \ \ \ p-\/>next\_\ =\ \textcolor{keyword}{this};}
\DoxyCodeLine{00115\ \ \ \ \ next\_\ =\ ptr;}
\DoxyCodeLine{00116\ \ \ \}}
\DoxyCodeLine{00117\ }
...
\DoxyCodeLine{00121\ \ \ \ \ \ \ GTEST\_LOCK\_EXCLUDED\_(g\_linked\_ptr\_mutex)\ \{}
\DoxyCodeLine{00122\ \ \ \ \ MutexLock\ lock(\&g\_linked\_ptr\_mutex);}
\DoxyCodeLine{00123\ }
...
\DoxyCodeLine{00125\ \ \ \ \ \doxymbox{\hyperlink{classtesting_1_1internal_1_1linked__ptr__internal}{linked\_ptr\_internal}}\ \textcolor{keyword}{const}*\ p\ =\ next\_;}
\DoxyCodeLine{00126\ \ \ \ \ \textcolor{keywordflow}{while}\ (p-\/>next\_\ !=\ \textcolor{keyword}{this})\ p\ =\ p-\/>next\_;}
\DoxyCodeLine{00127\ \ \ \ \ p-\/>next\_\ =\ next\_;}
\DoxyCodeLine{00128\ \ \ \ \ \textcolor{keywordflow}{return}\ \textcolor{keyword}{false};}
\DoxyCodeLine{00129\ \ \ \}}
\DoxyCodeLine{00130\ }
\DoxyCodeLine{00131\ \ \textcolor{keyword}{private}:}
\DoxyCodeLine{00132\ \ \ \textcolor{keyword}{mutable}\ \doxymbox{\hyperlink{classtesting_1_1internal_1_1linked__ptr__internal}{linked\_ptr\_internal}}\ \textcolor{keyword}{const}*\ next\_;}
\DoxyCodeLine{00133\ \};}
\DoxyCodeLine{00134\ }
\DoxyCodeLine{00135\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ T>}
\DoxyCodeLine{00136\ \textcolor{keyword}{class\ }linked\_ptr\ \{}
\DoxyCodeLine{00137\ \ \textcolor{keyword}{public}:}
\DoxyCodeLine{00138\ \ \ \textcolor{keyword}{typedef}\ T\ element\_type;}
\DoxyCodeLine{00139\ }
...
\DoxyCodeLine{00142\ \ \ \textcolor{keyword}{explicit}\ linked\_ptr(T*\ ptr\ =\ NULL)\ \{\ capture(ptr);\ \}}
\DoxyCodeLine{00143\ \ \ \string~linked\_ptr()\ \{\ depart();\ \}}
\DoxyCodeLine{00144\ }
\DoxyCodeLine{00145\ \ \ \textcolor{comment}{//\ Copy\ an\ existing\ linked\_ptr<>,\ adding\ ourselves\ to\ the\ list\ of\ references.}}
\DoxyCodeLine{00146\ \ \ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ U>\ linked\_ptr(linked\_ptr<U>\ \textcolor{keyword}{const}\&\ ptr)\ \{\ copy(\&ptr);\ \}}
\DoxyCodeLine{00147\ \ \ linked\_ptr(linked\_ptr\ \textcolor{keyword}{const}\&\ ptr)\ \{\ \ \textcolor{comment}{//\ NOLINT}}
\DoxyCodeLine{00148\ \ \ \ \ assert(\&ptr\ !=\ \textcolor{keyword}{this});}
\DoxyCodeLine{00149\ \ \ \ \ copy(\&ptr);}
\DoxyCodeLine{00150\ \ \ \}}
\DoxyCodeLine{00151\ }
\DoxyCodeLine{00152\ \ \ \textcolor{comment}{//\ Assignment\ releases\ the\ old\ value\ and\ acquires\ the\ new.}}
\DoxyCodeLine{00153\ \ \ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ U>\ linked\_ptr\&\ operator=(linked\_ptr<U>\ \textcolor{keyword}{const}\&\ ptr)\ \{}
\DoxyCodeLine{00154\ \ \ \ \ depart();}
\DoxyCodeLine{00155\ \ \ \ \ copy(\&ptr);}
\DoxyCodeLine{00156\ \ \ \ \ \textcolor{keywordflow}{return}\ *\textcolor{keyword}{this};}
\DoxyCodeLine{00157\ \ \ \}}
\DoxyCodeLine{00158\ }
\DoxyCodeLine{00159\ \ \ linked\_ptr\&\ operator=(linked\_ptr\ \textcolor{keyword}{const}\&\ ptr)\ \{}
\DoxyCodeLine{00160\ \ \ \ \ \textcolor{keywordflow}{if}\ (\&ptr\ !=\ \textcolor{keyword}{this})\ \{}
\DoxyCodeLine{00161\ \ \ \ \ \ \ depart();}
\DoxyCodeLine{00162\ \ \ \ \ \ \ copy(\&ptr);}
\DoxyCodeLine{00163\ \ \ \ \ \}}
...
\DoxyCodeLine{00168\ \ \ \textcolor{keywordtype}{void}\ reset(T*\ ptr\ =\ NULL)\ \{}
\DoxyCodeLine{00169\ \ \ \ \ depart();}
\DoxyCodeLine{00170\ \ \ \ \ capture(ptr);}
\DoxyCodeLine{00171\ \ \ \}}
\DoxyCodeLine{00172\ \ \ T*\ get()\textcolor{keyword}{\ const\ }\{\ \textcolor{keywordflow}{return}\ value\_;\ \}}
\DoxyCodeLine{00173\ \ \ T*\ operator-\/>()\textcolor{keyword}{\ const\ }\{\ \textcolor{keywordflow}{return}\ value\_;\ \}}
\DoxyCodeLine{00174\ \ \ T\&\ operator*()\textcolor{keyword}{\ const\ }\{\ \textcolor{keywordflow}{return}\ *value\_;\ \}}
\DoxyCodeLine{00175\ }
\DoxyCodeLine{00176\ \ \ \textcolor{keywordtype}{bool}\ operator==(T*\ p)\textcolor{keyword}{\ const\ }\{\ \textcolor{keywordflow}{return}\ value\_\ ==\ p;\ \}}
\DoxyCodeLine{00177\ \ \ \textcolor{keywordtype}{bool}\ operator!=(T*\ p)\textcolor{keyword}{\ const\ }\{\ \textcolor{keywordflow}{return}\ value\_\ !=\ p;\ \}}
\DoxyCodeLine{00178\ \ \ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ U>}
\DoxyCodeLine{00179\ \ \ \textcolor{keywordtype}{bool}\ operator==(linked\_ptr<U>\ \textcolor{keyword}{const}\&\ ptr)\textcolor{keyword}{\ const\ }\{}
\DoxyCodeLine{00180\ \ \ \ \ \textcolor{keywordflow}{return}\ value\_\ ==\ ptr.get();}
\DoxyCodeLine{00181\ \ \ \}}
\DoxyCodeLine{00182\ \ \ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ U>}
\DoxyCodeLine{00183\ \ \ \textcolor{keywordtype}{bool}\ operator!=(linked\_ptr<U>\ \textcolor{keyword}{const}\&\ ptr)\textcolor{keyword}{\ const\ }\{}
\DoxyCodeLine{00184\ \ \ \ \ \textcolor{keywordflow}{return}\ value\_\ !=\ ptr.get();}
\DoxyCodeLine{00185\ \ \ \}}
\DoxyCodeLine{00186\ }
\DoxyCodeLine{00187\ \ \textcolor{keyword}{private}:}
\DoxyCodeLine{00188\ \ \ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ U>}
\DoxyCodeLine{00189\ \ \ \textcolor{keyword}{friend}\ \textcolor{keyword}{class\ }linked\_ptr;}
\DoxyCodeLine{00190\ }
\DoxyCodeLine{00191\ \ \ T*\ value\_;}
\DoxyCodeLine{00192\ \ \ \doxymbox{\hyperlink{classtesting_1_1internal_1_1linked__ptr__internal}{linked\_ptr\_internal}}\ link\_;}
\DoxyCodeLine{00193\ }
...
\DoxyCodeLine{00196\ \ \ \}}
\DoxyCodeLine{00197\ }
\DoxyCodeLine{00198\ \ \ \textcolor{keywordtype}{void}\ capture(T*\ ptr)\ \{}
\DoxyCodeLine{00199\ \ \ \ \ value\_\ =\ ptr;}
\DoxyCodeLine{00200\ \ \ \ \ link\_.join\_new();}
\DoxyCodeLine{00201\ \ \ \}}
\DoxyCodeLine{00202\ }
\DoxyCodeLine{00203\ \ \ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ U>\ \textcolor{keywordtype}{void}\ copy(linked\_ptr<U>\ \textcolor{keyword}{const}*\ ptr)\ \{}
\DoxyCodeLine{00204\ \ \ \ \ value\_\ =\ ptr-\/>get();}
\DoxyCodeLine{00205\ \ \ \ \ \textcolor{keywordflow}{if}\ (value\_)}
\DoxyCodeLine{00206\ \ \ \ \ \ \ link\_.join(\&ptr-\/>link\_);}
...
\DoxyCodeLine{00213\ \textcolor{keywordtype}{bool}\ operator==(T*\ ptr,\ \textcolor{keyword}{const}\ \doxymbox{\hyperlink{classtesting_1_1internal_1_1linked__ptr}{linked\_ptr<T>}}\&\ x)\ \{}
\DoxyCodeLine{00214\ \ \ \textcolor{keywordflow}{return}\ ptr\ ==\ x.get();}
\DoxyCodeLine{00215\ \}}
\DoxyCodeLine{00216\ }
