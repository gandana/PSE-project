...
\DoxyCodeLine{00096\ \doxymbox{\hyperlink{classtesting_1_1internal_1_1_file_path}{FilePath}}\ FilePath::GetCurrentDir()\ \{}
...
\DoxyCodeLine{00123\ \doxymbox{\hyperlink{classtesting_1_1internal_1_1_file_path}{FilePath}}\ FilePath::RemoveExtension(\textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ extension)\textcolor{keyword}{\ const\ }\{}
...
\DoxyCodeLine{00193\ \doxymbox{\hyperlink{classtesting_1_1internal_1_1_file_path}{FilePath}}\ FilePath::RemoveDirectoryName()\textcolor{keyword}{\ const\ }\{}
...
\DoxyCodeLine{00204\ \doxymbox{\hyperlink{classtesting_1_1internal_1_1_file_path}{FilePath}}\ FilePath::RemoveFileName()\textcolor{keyword}{\ const\ }\{}
...
\DoxyCodeLine{00221\ \doxymbox{\hyperlink{classtesting_1_1internal_1_1_file_path}{FilePath}}\ FilePath::MakeFileName(\textcolor{keyword}{const}\ \doxymbox{\hyperlink{classtesting_1_1internal_1_1_file_path}{FilePath}}\&\ directory,}
\DoxyCodeLine{00222\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ \doxymbox{\hyperlink{classtesting_1_1internal_1_1_file_path}{FilePath}}\&\ base\_name,\ \textcolor{keywordtype}{int}\ number,}
...
\DoxyCodeLine{00236\ \doxymbox{\hyperlink{classtesting_1_1internal_1_1_file_path}{FilePath}}\ FilePath::ConcatPaths(\textcolor{keyword}{const}\ \doxymbox{\hyperlink{classtesting_1_1internal_1_1_file_path}{FilePath}}\&\ directory,}
\DoxyCodeLine{00237\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ \doxymbox{\hyperlink{classtesting_1_1internal_1_1_file_path}{FilePath}}\&\ relative\_path)\ \{}
...
\DoxyCodeLine{00308\ \doxymbox{\hyperlink{classtesting_1_1internal_1_1_file_path}{FilePath}}\ FilePath::GenerateUniqueFileName(\textcolor{keyword}{const}\ \doxymbox{\hyperlink{classtesting_1_1internal_1_1_file_path}{FilePath}}\&\ directory,}
\DoxyCodeLine{00309\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ \doxymbox{\hyperlink{classtesting_1_1internal_1_1_file_path}{FilePath}}\&\ base\_name,}
...
\DoxyCodeLine{00371\ \doxymbox{\hyperlink{classtesting_1_1internal_1_1_file_path}{FilePath}}\ FilePath::RemoveTrailingPathSeparator()\textcolor{keyword}{\ const\ }\{}
