...
\hypertarget{gtest_2include_2gtest_2internal_2gtest-internal_8h_source}{}\label{gtest_2include_2gtest_2internal_2gtest-internal_8h_source}\index{gtest/include/gtest/internal/gtest-\/internal.h@{gtest/include/gtest/internal/gtest-\/internal.h}}
...
\DoxyCodeLine{00082\ }
\DoxyCodeLine{00083\ \textcolor{keyword}{class\ }\doxymbox{\hyperlink{classtesting_1_1_assertion_result}{AssertionResult}};\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ Result\ of\ an\ assertion.}}
\DoxyCodeLine{00084\ \textcolor{keyword}{class\ }\doxymbox{\hyperlink{classtesting_1_1_message}{Message}};\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ Represents\ a\ failure\ message.}}
\DoxyCodeLine{00085\ \textcolor{keyword}{class\ }\doxymbox{\hyperlink{classtesting_1_1_test}{Test}};\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ Represents\ a\ test.}}
\DoxyCodeLine{00086\ \textcolor{keyword}{class\ }\doxymbox{\hyperlink{classtesting_1_1_test_info}{TestInfo}};\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ Information\ about\ a\ test.}}
\DoxyCodeLine{00087\ \textcolor{keyword}{class\ }\doxymbox{\hyperlink{classtesting_1_1_test_part_result}{TestPartResult}};\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ Result\ of\ a\ test\ part.}}
\DoxyCodeLine{00088\ \textcolor{keyword}{class\ }\doxymbox{\hyperlink{classtesting_1_1_unit_test}{UnitTest}};\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ A\ collection\ of\ test\ cases.}}
\DoxyCodeLine{00089\ }
...
\DoxyCodeLine{00094\ }
\DoxyCodeLine{00095\ \textcolor{keyword}{struct\ }\doxymbox{\hyperlink{structtesting_1_1internal_1_1_trace_info}{TraceInfo}};\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ Information\ about\ a\ trace\ point.}}
\DoxyCodeLine{00096\ \textcolor{keyword}{class\ }\doxymbox{\hyperlink{classtesting_1_1internal_1_1_scoped_trace}{ScopedTrace}};\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ Implements\ scoped\ trace.}}
\DoxyCodeLine{00097\ \textcolor{keyword}{class\ }TestInfoImpl;\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ Opaque\ implementation\ of\ TestInfo}}
\DoxyCodeLine{00098\ \textcolor{keyword}{class\ }\doxymbox{\hyperlink{classtesting_1_1internal_1_1_unit_test_impl}{UnitTestImpl}};\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ Opaque\ implementation\ of\ UnitTest}}
\DoxyCodeLine{00099\ }
...
\DoxyCodeLine{00156\ \textcolor{keyword}{class\ }GTEST\_API\_\ ScopedTrace\ \{}
...
\DoxyCodeLine{00160\ \ \ ScopedTrace(\textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ file,\ \textcolor{keywordtype}{int}\ line,\ \textcolor{keyword}{const}\ \doxymbox{\hyperlink{classtesting_1_1_message}{Message}}\&\ message);}
\DoxyCodeLine{00161\ }
...
\DoxyCodeLine{00166\ \ \ \string~ScopedTrace();}
\DoxyCodeLine{00167\ }
\DoxyCodeLine{00168\ \ \textcolor{keyword}{private}:}
\DoxyCodeLine{00169\ \ \ GTEST\_DISALLOW\_COPY\_AND\_ASSIGN\_(ScopedTrace);}
...
\DoxyCodeLine{00189\ GTEST\_API\_\ \doxymbox{\hyperlink{classtesting_1_1_assertion_result}{AssertionResult}}\ EqFailure(\textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ expected\_expression,}
\DoxyCodeLine{00190\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ actual\_expression,}
\DoxyCodeLine{00191\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ std::string\&\ expected\_value,}
\DoxyCodeLine{00192\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ std::string\&\ actual\_value,}
\DoxyCodeLine{00193\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordtype}{bool}\ ignoring\_case);}
\DoxyCodeLine{00194\ }
...
\DoxyCodeLine{00197\ \ \ \ \ \textcolor{keyword}{const}\ \doxymbox{\hyperlink{classtesting_1_1_assertion_result}{AssertionResult}}\&\ assertion\_result,}
\DoxyCodeLine{00198\ \ \ \ \ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ expression\_text,}
\DoxyCodeLine{00199\ \ \ \ \ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ actual\_predicate\_value,}
\DoxyCodeLine{00200\ \ \ \ \ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ expected\_predicate\_value);}
\DoxyCodeLine{00201\ }
...
\DoxyCodeLine{00232\ \textcolor{keyword}{class\ }\doxymbox{\hyperlink{classtesting_1_1internal_1_1_floating_point}{FloatingPoint}}\ \{}
...
\DoxyCodeLine{00236\ \ \ \textcolor{keyword}{typedef}\ \textcolor{keyword}{typename}\ \doxymbox{\hyperlink{classtesting_1_1internal_1_1_type_with_size}{TypeWithSize}}<\textcolor{keyword}{sizeof}(RawType)>\doxymbox{\hyperlink{classtesting_1_1internal_1_1_type_with_size}{::UInt}}\ Bits;}
\DoxyCodeLine{00237\ }
\DoxyCodeLine{00238\ \ \ \textcolor{comment}{//\ Constants.}}
\DoxyCodeLine{00239\ }
\DoxyCodeLine{00240\ \ \ \textcolor{comment}{//\ \#\ of\ bits\ in\ a\ number.}}
\DoxyCodeLine{00241\ \ \ \textcolor{keyword}{static}\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{size\_t}\ kBitCount\ =\ 8*\textcolor{keyword}{sizeof}(RawType);}
\DoxyCodeLine{00242\ }
...
\DoxyCodeLine{00255\ \ \ \ \ \string~static\_cast<Bits>(0)\ >>\ (kExponentBitCount\ +\ 1);}
\DoxyCodeLine{00256\ }
...
\DoxyCodeLine{00280\ \ \ \textcolor{keyword}{explicit}\ \doxymbox{\hyperlink{classtesting_1_1internal_1_1_floating_point}{FloatingPoint}}(\textcolor{keyword}{const}\ RawType\&\ x)\ \{\ u\_.value\_\ =\ x;\ \}}
\DoxyCodeLine{00281\ }
...
\DoxyCodeLine{00287\ \ \ \textcolor{keyword}{static}\ RawType\ ReinterpretBits(\textcolor{keyword}{const}\ Bits\ bits)\ \{}
\DoxyCodeLine{00288\ \ \ \ \ \doxymbox{\hyperlink{class_floating_point}{FloatingPoint}}\ fp(0);}
\DoxyCodeLine{00289\ \ \ \ \ fp.u\_.bits\_\ =\ bits;}
\DoxyCodeLine{00290\ \ \ \ \ \textcolor{keywordflow}{return}\ fp.u\_.value\_;}
\DoxyCodeLine{00291\ \ \ \}}
\DoxyCodeLine{00292\ }
\DoxyCodeLine{00293\ \ \ \textcolor{comment}{//\ Returns\ the\ floating-\/point\ number\ that\ represent\ positive\ infinity.}}
\DoxyCodeLine{00294\ \ \ \textcolor{keyword}{static}\ RawType\ Infinity()\ \{}
...
\DoxyCodeLine{00299\ \ \ \textcolor{keyword}{static}\ RawType\ Max();}
\DoxyCodeLine{00300\ }
...
\DoxyCodeLine{00328\ \ \ \textcolor{keywordtype}{bool}\ AlmostEquals(\textcolor{keyword}{const}\ FloatingPoint\&\ rhs)\textcolor{keyword}{\ const\ }\{}
...
\DoxyCodeLine{00331\ \ \ \ \ \textcolor{keywordflow}{if}\ (is\_nan()\ ||\ rhs.is\_nan())\ \textcolor{keywordflow}{return}\ \textcolor{keyword}{false};}
\DoxyCodeLine{00332\ }
\DoxyCodeLine{00333\ \ \ \ \ \textcolor{keywordflow}{return}\ DistanceBetweenSignAndMagnitudeNumbers(u\_.bits\_,\ rhs.u\_.bits\_)}
...
\DoxyCodeLine{00340\ \ \ \ \ RawType\ value\_;\ \ \textcolor{comment}{//\ The\ raw\ floating-\/point\ number.}}
...
\DoxyCodeLine{00359\ \ \ \textcolor{keyword}{static}\ Bits\ SignAndMagnitudeToBiased(\textcolor{keyword}{const}\ Bits\ \&sam)\ \{}
\DoxyCodeLine{00360\ \ \ \ \ \textcolor{keywordflow}{if}\ (kSignBitMask\ \&\ sam)\ \{}
\DoxyCodeLine{00361\ \ \ \ \ \ \ \textcolor{comment}{//\ sam\ represents\ a\ negative\ number.}}
\DoxyCodeLine{00362\ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ \string~sam\ +\ 1;}
\DoxyCodeLine{00363\ \ \ \ \ \}\ \textcolor{keywordflow}{else}\ \{}
\DoxyCodeLine{00364\ \ \ \ \ \ \ \textcolor{comment}{//\ sam\ represents\ a\ positive\ number.}}
\DoxyCodeLine{00365\ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ kSignBitMask\ |\ sam;}
\DoxyCodeLine{00366\ \ \ \ \ \}}
\DoxyCodeLine{00367\ \ \ \}}
\DoxyCodeLine{00368\ }
...
\DoxyCodeLine{00371\ \ \ \textcolor{keyword}{static}\ Bits\ DistanceBetweenSignAndMagnitudeNumbers(\textcolor{keyword}{const}\ Bits\ \&sam1,}
\DoxyCodeLine{00372\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ Bits\ \&sam2)\ \{}
...
\DoxyCodeLine{00384\ \textcolor{keyword}{inline}\ \textcolor{keywordtype}{float}\ FloatingPoint<float>::Max()\ \{\ \textcolor{keywordflow}{return}\ FLT\_MAX;\ \}}
...
\DoxyCodeLine{00390\ \textcolor{keyword}{typedef}\ \doxymbox{\hyperlink{classtesting_1_1internal_1_1_floating_point}{FloatingPoint<float>}}\ Float;}
\DoxyCodeLine{00391\ \textcolor{keyword}{typedef}\ \doxymbox{\hyperlink{classtesting_1_1internal_1_1_floating_point}{FloatingPoint<double>}}\ Double;}
\DoxyCodeLine{00392\ }
...
\DoxyCodeLine{00402\ \textcolor{keyword}{class\ }\doxymbox{\hyperlink{classtesting_1_1internal_1_1_type_id_helper}{TypeIdHelper}}\ \{}
...
\DoxyCodeLine{00411\ \textcolor{keywordtype}{bool}\ TypeIdHelper<T>::dummy\_\ =\ \textcolor{keyword}{false};}
\DoxyCodeLine{00412\ }
...
\DoxyCodeLine{00417\ TypeId\ GetTypeId()\ \{}
...
\DoxyCodeLine{00422\ \ \ \textcolor{keywordflow}{return}\ \&(TypeIdHelper<T>::dummy\_);}
\DoxyCodeLine{00423\ \}}
\DoxyCodeLine{00424\ }
...
\DoxyCodeLine{00434\ \textcolor{keyword}{class\ }\doxymbox{\hyperlink{classtesting_1_1internal_1_1_test_factory_base}{TestFactoryBase}}\ \{}
\DoxyCodeLine{00435\ \ \textcolor{keyword}{public}:}
\DoxyCodeLine{00436\ \ \ \textcolor{keyword}{virtual}\ \string~TestFactoryBase()\ \{\}}
\DoxyCodeLine{00437\ }
...
\DoxyCodeLine{00440\ \ \ \textcolor{keyword}{virtual}\ Test*\ CreateTest()\ =\ 0;}
\DoxyCodeLine{00441\ }
\DoxyCodeLine{00442\ \ \textcolor{keyword}{protected}:}
\DoxyCodeLine{00443\ \ \ TestFactoryBase()\ \{\}}
\DoxyCodeLine{00444\ }
\DoxyCodeLine{00445\ \ \textcolor{keyword}{private}:}
\DoxyCodeLine{00446\ \ \ GTEST\_DISALLOW\_COPY\_AND\_ASSIGN\_(TestFactoryBase);}
\DoxyCodeLine{00447\ \};}
\DoxyCodeLine{00448\ }
...
\DoxyCodeLine{00452\ \textcolor{keyword}{class\ }\doxymbox{\hyperlink{classtesting_1_1internal_1_1_test_factory_impl}{TestFactoryImpl}}\ :\ \textcolor{keyword}{public}\ \doxymbox{\hyperlink{classtesting_1_1internal_1_1_test_factory_base}{TestFactoryBase}}\ \{}
\DoxyCodeLine{00453\ \ \textcolor{keyword}{public}:}
\DoxyCodeLine{00454\ \ \ \textcolor{keyword}{virtual}\ Test*\ CreateTest()\ \{\ \textcolor{keywordflow}{return}\ \textcolor{keyword}{new}\ TestClass;\ \}}
\DoxyCodeLine{00455\ \};}
\DoxyCodeLine{00456\ }
...
\DoxyCodeLine{00463\ GTEST\_API\_\ AssertionResult\ IsHRESULTSuccess(\textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ expr,}
\DoxyCodeLine{00464\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordtype}{long}\ hr);\ \ \textcolor{comment}{//\ NOLINT}}
\DoxyCodeLine{00465\ GTEST\_API\_\ AssertionResult\ IsHRESULTFailure(\textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ expr,}
...
\DoxyCodeLine{00471\ \textcolor{keyword}{typedef}\ void\ (*SetUpTestCaseFunc)();}
\DoxyCodeLine{00472\ \textcolor{keyword}{typedef}\ void\ (*TearDownTestCaseFunc)();}
\DoxyCodeLine{00473\ }
...
\DoxyCodeLine{00491\ GTEST\_API\_\ TestInfo*\ MakeAndRegisterTestInfo(}
...
\DoxyCodeLine{00496\ \ \ \ \ TypeId\ fixture\_class\_id,}
\DoxyCodeLine{00497\ \ \ \ \ SetUpTestCaseFunc\ set\_up\_tc,}
\DoxyCodeLine{00498\ \ \ \ \ TearDownTestCaseFunc\ tear\_down\_tc,}
\DoxyCodeLine{00499\ \ \ \ \ \doxymbox{\hyperlink{classtesting_1_1internal_1_1_test_factory_base}{TestFactoryBase}}*\ factory);}
\DoxyCodeLine{00500\ }
...
\DoxyCodeLine{00504\ GTEST\_API\_\ \textcolor{keywordtype}{bool}\ SkipPrefix(\textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ prefix,\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}**\ pstr);}
\DoxyCodeLine{00505\ }
...
\DoxyCodeLine{00509\ \textcolor{keyword}{class\ }GTEST\_API\_\ TypedTestCasePState\ \{}
\DoxyCodeLine{00510\ \ \textcolor{keyword}{public}:}
\DoxyCodeLine{00511\ \ \ TypedTestCasePState()\ :\ registered\_(false)\ \{\}}
\DoxyCodeLine{00512\ }
...
\DoxyCodeLine{00566\ \textcolor{keyword}{class\ }\doxymbox{\hyperlink{classtesting_1_1internal_1_1_type_parameterized_test}{TypeParameterizedTest}}\ \{}
...
\DoxyCodeLine{00589\ \ \ \ \ \ \ \ \ \textcolor{keyword}{new}\ TestFactoryImpl<TestClass>);}
\DoxyCodeLine{00590\ }
...
\DoxyCodeLine{00599\ \textcolor{keyword}{class\ }\doxymbox{\hyperlink{classtesting_1_1internal_1_1_type_parameterized_test}{TypeParameterizedTest}}<Fixture,\ TestSel,\ Types0>\ \{}
...
\DoxyCodeLine{00630\ \textcolor{keyword}{class\ }TypeParameterizedTestCase<Fixture,\ Templates0,\ \doxymbox{\hyperlink{structtesting_1_1internal_1_1_types}{Types}}>\ \{}
...
\DoxyCodeLine{00665\ \textcolor{keyword}{struct\ }GTEST\_API\_\ \doxymbox{\hyperlink{structtesting_1_1internal_1_1_const_char_ptr}{ConstCharPtr}}\ \{}
\DoxyCodeLine{00666\ \ \ ConstCharPtr(\textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ str)\ :\ value(str)\ \{\}}
\DoxyCodeLine{00667\ \ \ \textcolor{keyword}{operator}\ bool()\textcolor{keyword}{\ const\ }\{\ \textcolor{keywordflow}{return}\ \textcolor{keyword}{true};\ \}}
...
\DoxyCodeLine{00676\ \textcolor{keyword}{class\ }GTEST\_API\_\ \doxymbox{\hyperlink{classtesting_1_1internal_1_1_random}{Random}}\ \{}
...
\DoxyCodeLine{00679\ }
\DoxyCodeLine{00680\ \ \ \textcolor{keyword}{explicit}\ Random(UInt32\ seed)\ :\ state\_(seed)\ \{\}}
\DoxyCodeLine{00681\ }
\DoxyCodeLine{00682\ \ \ \textcolor{keywordtype}{void}\ Reseed(UInt32\ seed)\ \{\ state\_\ =\ seed;\ \}}
\DoxyCodeLine{00683\ }
...
\DoxyCodeLine{00686\ \ \ UInt32\ Generate(UInt32\ range);}
\DoxyCodeLine{00687\ }
\DoxyCodeLine{00688\ \ \textcolor{keyword}{private}:}
\DoxyCodeLine{00689\ \ \ UInt32\ state\_;}
\DoxyCodeLine{00690\ \ \ GTEST\_DISALLOW\_COPY\_AND\_ASSIGN\_(Random);}
\DoxyCodeLine{00691\ \};}
\DoxyCodeLine{00692\ }
...
\DoxyCodeLine{00696\ \textcolor{keyword}{struct\ }\doxymbox{\hyperlink{structtesting_1_1internal_1_1_compile_assert_types_equal}{CompileAssertTypesEqual}};}
\DoxyCodeLine{00697\ }
\DoxyCodeLine{00698\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ T>}
\DoxyCodeLine{00699\ \textcolor{keyword}{struct\ }\doxymbox{\hyperlink{structtesting_1_1internal_1_1_compile_assert_types_equal}{CompileAssertTypesEqual}}<T,\ T>\ \{}
\DoxyCodeLine{00700\ \};}
\DoxyCodeLine{00701\ }
...
\DoxyCodeLine{00706\ \textcolor{keyword}{struct\ }\doxymbox{\hyperlink{structtesting_1_1internal_1_1_remove_reference}{RemoveReference}}\ \{\ \textcolor{keyword}{typedef}\ T\ type;\ \};\ \ \textcolor{comment}{//\ NOLINT}}
\DoxyCodeLine{00707\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ T>}
\DoxyCodeLine{00708\ \textcolor{keyword}{struct\ }\doxymbox{\hyperlink{structtesting_1_1internal_1_1_remove_reference}{RemoveReference}}<T\&>\ \{\ \textcolor{keyword}{typedef}\ T\ type;\ \};\ \ \textcolor{comment}{//\ NOLINT}}
\DoxyCodeLine{00709\ }
...
\DoxyCodeLine{00719\ \textcolor{keyword}{struct\ }\doxymbox{\hyperlink{structtesting_1_1internal_1_1_remove_const}{RemoveConst}}\ \{\ \textcolor{keyword}{typedef}\ T\ type;\ \};\ \ \textcolor{comment}{//\ NOLINT}}
\DoxyCodeLine{00720\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ T>}
\DoxyCodeLine{00721\ \textcolor{keyword}{struct\ }\doxymbox{\hyperlink{structtesting_1_1internal_1_1_remove_const}{RemoveConst}}<const\ T>\ \{\ \textcolor{keyword}{typedef}\ T\ type;\ \};\ \ \textcolor{comment}{//\ NOLINT}}
\DoxyCodeLine{00722\ }
...
\DoxyCodeLine{00727\ \textcolor{keyword}{struct\ }\doxymbox{\hyperlink{structtesting_1_1internal_1_1_remove_const}{RemoveConst}}<const\ T[N]>\ \{}
\DoxyCodeLine{00728\ \ \ \textcolor{keyword}{typedef}\ \textcolor{keyword}{typename}\ RemoveConst<T>::type\ type[N];}
\DoxyCodeLine{00729\ \};}
\DoxyCodeLine{00730\ }
...
\DoxyCodeLine{00736\ \textcolor{keyword}{struct\ }\doxymbox{\hyperlink{structtesting_1_1internal_1_1_remove_const}{RemoveConst}}<T[N]>\ \{}
\DoxyCodeLine{00737\ \ \ \textcolor{keyword}{typedef}\ \textcolor{keyword}{typename}\ RemoveConst<T>::type\ \doxymbox{\hyperlink{structtesting_1_1internal_1_1_remove_const}{type}}[N];}
\DoxyCodeLine{00738\ \};}
...
\DoxyCodeLine{00754\ \textcolor{keyword}{struct\ }\doxymbox{\hyperlink{structtesting_1_1internal_1_1_add_reference}{AddReference}}\ \{\ \textcolor{keyword}{typedef}\ T\&\ type;\ \};\ \ \textcolor{comment}{//\ NOLINT}}
\DoxyCodeLine{00755\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ T>}
\DoxyCodeLine{00756\ \textcolor{keyword}{struct\ }\doxymbox{\hyperlink{structtesting_1_1internal_1_1_add_reference}{AddReference}}<T\&>\ \{\ \textcolor{keyword}{typedef}\ T\&\ type;\ \};\ \ \textcolor{comment}{//\ NOLINT}}
\DoxyCodeLine{00757\ }
...
\DoxyCodeLine{00779\ \textcolor{keyword}{class\ }\doxymbox{\hyperlink{classtesting_1_1internal_1_1_implicitly_convertible}{ImplicitlyConvertible}}\ \{}
...
\DoxyCodeLine{00787\ \ \ \textcolor{keyword}{static}\ From\ MakeFrom();}
\DoxyCodeLine{00788\ }
...
\DoxyCodeLine{00799\ \ \ \textcolor{keyword}{static}\ \textcolor{keywordtype}{char}\ Helper(\doxymbox{\hyperlink{classtesting_1_1internal_1_1_to}{To}});}
\DoxyCodeLine{00800\ \ \ \textcolor{keyword}{static}\ char\ (\&Helper(...))[2];\ \ \textcolor{comment}{//\ NOLINT}}
\DoxyCodeLine{00801\ }
...
\DoxyCodeLine{00819\ \ \ \textcolor{keyword}{static}\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{bool}\ value\ =\ \_\_is\_convertible(From,\ \doxymbox{\hyperlink{classtesting_1_1internal_1_1_to}{To}});}
...
\DoxyCodeLine{00826\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{bool}\ ImplicitlyConvertible<From,\ To>::value;}
\DoxyCodeLine{00827\ }
...
\DoxyCodeLine{00832\ \textcolor{keyword}{struct\ }\doxymbox{\hyperlink{structtesting_1_1internal_1_1_is_a_protocol_message}{IsAProtocolMessage}}}
\DoxyCodeLine{00833\ \ \ \ \ :\ \textcolor{keyword}{public}\ \doxymbox{\hyperlink{structtesting_1_1internal_1_1bool__constant}{bool\_constant}}<}
...
\DoxyCodeLine{00862\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keyword}{typename}\ C::iterator*\ \textcolor{comment}{/*\ it\ */}\ =\ NULL,}
\DoxyCodeLine{00863\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keyword}{typename}\ C::const\_iterator*\ \textcolor{comment}{/*\ const\_it\ */}\ =\ NULL)\ \{}
...
\DoxyCodeLine{00875\ \textcolor{keyword}{template}<\textcolor{keywordtype}{bool}>\ \textcolor{keyword}{struct\ }\doxymbox{\hyperlink{structtesting_1_1internal_1_1_enable_if}{EnableIf}};}
\DoxyCodeLine{00876\ \textcolor{keyword}{template}<>\ \textcolor{keyword}{struct\ }\doxymbox{\hyperlink{structtesting_1_1internal_1_1_enable_if}{EnableIf}}<true>\ \{\ \textcolor{keyword}{typedef}\ \textcolor{keywordtype}{void}\ type;\ \};\ \ \textcolor{comment}{//\ NOLINT}}
\DoxyCodeLine{00877\ }
...
\DoxyCodeLine{00885\ \textcolor{keywordtype}{bool}\ ArrayEq(\textcolor{keyword}{const}\ T*\ lhs,\ \textcolor{keywordtype}{size\_t}\ size,\ \textcolor{keyword}{const}\ U*\ rhs);}
\DoxyCodeLine{00886\ }
...
\DoxyCodeLine{00889\ \textcolor{keyword}{inline}\ \textcolor{keywordtype}{bool}\ ArrayEq(\textcolor{keyword}{const}\ T\&\ lhs,\ \textcolor{keyword}{const}\ U\&\ rhs)\ \{\ \textcolor{keywordflow}{return}\ lhs\ ==\ rhs;\ \}}
\DoxyCodeLine{00890\ }
...
\DoxyCodeLine{00964\ \textcolor{keyword}{class\ }\doxymbox{\hyperlink{classtesting_1_1internal_1_1_native_array}{NativeArray}}\ \{}
...
\DoxyCodeLine{00972\ \ \ NativeArray(\textcolor{keyword}{const}\ Element*\ array,\ \textcolor{keywordtype}{size\_t}\ count,\ RelationToSource\ relation)\ \{}
\DoxyCodeLine{00973\ \ \ \ \ Init(array,\ count,\ relation);}
\DoxyCodeLine{00974\ \ \ \}}
\DoxyCodeLine{00975\ }
\DoxyCodeLine{00976\ \ \ \textcolor{comment}{//\ Copy\ constructor.}}
\DoxyCodeLine{00977\ \ \ NativeArray(\textcolor{keyword}{const}\ NativeArray\&\ rhs)\ \{}
\DoxyCodeLine{00978\ \ \ \ \ Init(rhs.array\_,\ rhs.size\_,\ rhs.relation\_to\_source\_);}
\DoxyCodeLine{00979\ \ \ \}}
\DoxyCodeLine{00980\ }
\DoxyCodeLine{00981\ \ \ \string~NativeArray()\ \{}
...
\DoxyCodeLine{00984\ \ \ \ \ \textcolor{keyword}{static\_cast<}\textcolor{keywordtype}{void}\textcolor{keyword}{>}(StaticAssertTypeEqHelper<Element,}
...
\DoxyCodeLine{00994\ \ \ \textcolor{keywordtype}{bool}\ operator==(\textcolor{keyword}{const}\ NativeArray\&\ rhs)\textcolor{keyword}{\ const\ }\{}
\DoxyCodeLine{00995\ \ \ \ \ \textcolor{keywordflow}{return}\ size()\ ==\ rhs.size()\ \&\&}
\DoxyCodeLine{00996\ \ \ \ \ \ \ \ \ ArrayEq(begin(),\ size(),\ rhs.begin());}
\DoxyCodeLine{00997\ \ \ \}}
\DoxyCodeLine{00998\ }
...
\DoxyCodeLine{01002\ \ \ \textcolor{keywordtype}{void}\ Init(\textcolor{keyword}{const}\ Element*\ array,\ \textcolor{keywordtype}{size\_t}\ a\_size,\ RelationToSource\ relation)\ \{}
\DoxyCodeLine{01003\ \ \ \ \ \textcolor{keywordflow}{if}\ (relation\ ==\ kReference)\ \{}
\DoxyCodeLine{01004\ \ \ \ \ \ \ array\_\ =\ array;}
\DoxyCodeLine{01005\ \ \ \ \ \}\ \textcolor{keywordflow}{else}\ \{}
\DoxyCodeLine{01006\ \ \ \ \ \ \ Element*\ \textcolor{keyword}{const}\ copy\ =\ \textcolor{keyword}{new}\ Element[a\_size];}
\DoxyCodeLine{01007\ \ \ \ \ \ \ CopyArray(array,\ a\_size,\ copy);}
\DoxyCodeLine{01008\ \ \ \ \ \ \ array\_\ =\ copy;}
\DoxyCodeLine{01009\ \ \ \ \ \}}
\DoxyCodeLine{01010\ \ \ \ \ size\_\ =\ a\_size;}
\DoxyCodeLine{01011\ \ \ \ \ relation\_to\_source\_\ =\ relation;}
\DoxyCodeLine{01012\ \ \ \}}
\DoxyCodeLine{01013\ }
...
\DoxyCodeLine{01017\ }
\DoxyCodeLine{01018\ \ \ GTEST\_DISALLOW\_ASSIGN\_(NativeArray);}
\DoxyCodeLine{01019\ \};}
\DoxyCodeLine{01020\ }
