...
\hypertarget{gtest-assertion-result_8cc_source}{}\label{gtest-assertion-result_8cc_source}\index{cmake-\/build-\/debug/\_deps/googletest-\/src/googletest/src/gtest-\/assertion-\/result.cc@{cmake-\/build-\/debug/\_deps/googletest-\/src/googletest/src/gtest-\/assertion-\/result.cc}}
...
\DoxyCodeLine{00045\ AssertionResult::AssertionResult(\textcolor{keyword}{const}\ \doxymbox{\hyperlink{classtesting_1_1_assertion_result}{AssertionResult}}\&\ other)}
...
\DoxyCodeLine{00052\ \textcolor{keywordtype}{void}\ AssertionResult::swap(\doxymbox{\hyperlink{class_assertion_result}{AssertionResult}}\&\ other)\ \{}
...
\DoxyCodeLine{00059\ \doxymbox{\hyperlink{class_assertion_result}{AssertionResult}}\ AssertionResult::operator!()\textcolor{keyword}{\ const\ }\{}
...
\DoxyCodeLine{00066\ \doxymbox{\hyperlink{class_assertion_result}{AssertionResult}}\ AssertionSuccess()\ \{\ \textcolor{keywordflow}{return}\ \doxymbox{\hyperlink{class_assertion_result}{AssertionResult}}(\textcolor{keyword}{true});\ \}}
\DoxyCodeLine{00067\ }
\DoxyCodeLine{00068\ \textcolor{comment}{//\ Makes\ a\ failed\ assertion\ result.}}
\DoxyCodeLine{00069\ \doxymbox{\hyperlink{class_assertion_result}{AssertionResult}}\ AssertionFailure()\ \{\ \textcolor{keywordflow}{return}\ \doxymbox{\hyperlink{class_assertion_result}{AssertionResult}}(\textcolor{keyword}{false});\ \}}
\DoxyCodeLine{00070\ }
...
\DoxyCodeLine{00073\ \doxymbox{\hyperlink{class_assertion_result}{AssertionResult}}\ AssertionFailure(\textcolor{keyword}{const}\ \doxymbox{\hyperlink{class_message}{Message}}\&\ message)\ \{}
