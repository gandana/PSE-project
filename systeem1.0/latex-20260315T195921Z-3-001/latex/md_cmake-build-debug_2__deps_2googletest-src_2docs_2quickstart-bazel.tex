...
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2quickstart-bazel}{}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2quickstart-bazel}\index{Quickstart: Building with Bazel@{Quickstart: Building with Bazel}}
\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2quickstart-bazel_autotoc_md233}%
\Hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2quickstart-bazel_autotoc_md233}%


This tutorial aims to get you up and running with Google\+Test using the Bazel build system. If you\textquotesingle{}re using Google\+Test for the first time or need a refresher, we recommend this tutorial as a starting point.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2quickstart-bazel_autotoc_md234}{}\doxysection{\texorpdfstring{Prerequisites}{Prerequisites}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2quickstart-bazel_autotoc_md234}
...
\{:\+ .callout .note\} Note:\+ The terminal commands in this tutorial show a Unix shell prompt, but the commands work on the Windows command line as well.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2quickstart-bazel_autotoc_md235}{}\doxysection{\texorpdfstring{Set up a Bazel workspace}{Set up a Bazel workspace}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2quickstart-bazel_autotoc_md235}
...
Now you\textquotesingle{}re ready to build C++ code that uses Google\+Test.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2quickstart-bazel_autotoc_md236}{}\doxysection{\texorpdfstring{Create and run a binary}{Create and run a binary}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2quickstart-bazel_autotoc_md236}
...
Congratulations! You\textquotesingle{}ve successfully built and run a test binary using Google\+Test.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2quickstart-bazel_autotoc_md237}{}\doxysection{\texorpdfstring{Next steps}{Next steps}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2quickstart-bazel_autotoc_md237}
