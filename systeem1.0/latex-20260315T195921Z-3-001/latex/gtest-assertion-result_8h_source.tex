...
\hypertarget{gtest-assertion-result_8h_source}{}\label{gtest-assertion-result_8h_source}\index{cmake-\/build-\/debug/\_deps/googletest-\/src/googletest/include/gtest/gtest-\/assertion-\/result.h@{cmake-\/build-\/debug/\_deps/googletest-\/src/googletest/include/gtest/gtest-\/assertion-\/result.h}}
...
\DoxyCodeLine{00133\ \textcolor{keyword}{class\ }GTEST\_API\_\ \doxymbox{\hyperlink{class_assertion_result}{AssertionResult}}\ \{}
...
\DoxyCodeLine{00224\ GTEST\_API\_\ \doxymbox{\hyperlink{class_assertion_result}{AssertionResult}}\ AssertionSuccess();}
\DoxyCodeLine{00225\ }
\DoxyCodeLine{00226\ \textcolor{comment}{//\ Makes\ a\ failed\ assertion\ result.}}
\DoxyCodeLine{00227\ GTEST\_API\_\ \doxymbox{\hyperlink{class_assertion_result}{AssertionResult}}\ AssertionFailure();}
\DoxyCodeLine{00228\ }
...
\DoxyCodeLine{00231\ GTEST\_API\_\ \doxymbox{\hyperlink{class_assertion_result}{AssertionResult}}\ AssertionFailure(\textcolor{keyword}{const}\ \doxymbox{\hyperlink{class_message}{Message}}\&\ msg);}
\DoxyCodeLine{00232\ }
