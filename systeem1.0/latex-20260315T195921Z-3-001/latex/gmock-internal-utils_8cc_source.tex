...
\DoxyCodeLine{00100\ \textcolor{keyword}{class\ }\doxymbox{\hyperlink{classtesting_1_1internal_1_1_google_test_failure_reporter}{GoogleTestFailureReporter}}\ :\ \textcolor{keyword}{public}\ \doxymbox{\hyperlink{classtesting_1_1internal_1_1_failure_reporter_interface}{FailureReporterInterface}}\ \{}
\DoxyCodeLine{00101\ \ \textcolor{keyword}{public}:}
\DoxyCodeLine{00102\ \ \ \textcolor{keywordtype}{void}\ ReportFailure(FailureType\ \doxymbox{\hyperlink{structtesting_1_1internal_1_1_remove_const}{type}},\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ file,\ \textcolor{keywordtype}{int}\ line,}
\DoxyCodeLine{00103\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ std::string\&\ message)\textcolor{keyword}{\ override\ }\{}
\DoxyCodeLine{00104\ \ \ \ \ \doxymbox{\hyperlink{classtesting_1_1internal_1_1_assert_helper}{AssertHelper}}(\doxymbox{\hyperlink{structtesting_1_1internal_1_1_remove_const}{type}}\ ==\ kFatal\ ?\ TestPartResult::kFatalFailure}
\DoxyCodeLine{00105\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ :\ TestPartResult::kNonFatalFailure,}
\DoxyCodeLine{00106\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ file,\ line,\ message.c\_str())\ =\ \doxymbox{\hyperlink{classtesting_1_1_message}{Message}}();}
\DoxyCodeLine{00107\ \ \ \ \ \textcolor{keywordflow}{if}\ (\doxymbox{\hyperlink{structtesting_1_1internal_1_1_remove_const}{type}}\ ==\ kFatal)\ \{}
...
\DoxyCodeLine{00115\ GTEST\_API\_\ \doxymbox{\hyperlink{classtesting_1_1internal_1_1_failure_reporter_interface}{FailureReporterInterface}}*\ GetFailureReporter()\ \{}
...
\DoxyCodeLine{00121\ \ \ \textcolor{keyword}{static}\ \doxymbox{\hyperlink{classtesting_1_1internal_1_1_failure_reporter_interface}{FailureReporterInterface}}*\ \textcolor{keyword}{const}\ failure\_reporter\ =}
\DoxyCodeLine{00122\ \ \ \ \ \ \ \textcolor{keyword}{new}\ \doxymbox{\hyperlink{classtesting_1_1internal_1_1_google_test_failure_reporter}{GoogleTestFailureReporter}}();}
...
\DoxyCodeLine{00187\ \}}
\DoxyCodeLine{00188\ }
\DoxyCodeLine{00189\ GTEST\_API\_\ \doxymbox{\hyperlink{classtesting_1_1internal_1_1_without_matchers}{WithoutMatchers}}\ GetWithoutMatchers()\ \{\ \textcolor{keywordflow}{return}\ \doxymbox{\hyperlink{classtesting_1_1internal_1_1_without_matchers}{WithoutMatchers}}();\ \}}
\DoxyCodeLine{00190\ }
...
\DoxyCodeLine{00209\ \textcolor{keyword}{constexpr}\ std::array<char,\ 256>\ UnBase64Impl(\doxymbox{\hyperlink{structtesting_1_1internal_1_1_index_sequence}{IndexSequence<I...>}},}
