...
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2mocking}{}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2mocking}\index{Mocking Reference@{Mocking Reference}}
\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2mocking_autotoc_md262}%
\Hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2mocking_autotoc_md262}%


This page lists the facilities provided by Google\+Test for creating and working with mock objects. To use them, include the header {\ttfamily \doxylink{gmock_8h_source}{gmock/\+gmock.\+h}}.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2mocking_macros}{}\doxysection{\texorpdfstring{Macros}{Macros}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2mocking_macros}
Google\+Test defines the following macros for working with mocks.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2mocking_MOCK_METHOD}{}\doxysubsection{\texorpdfstring{MOCK\+\_\+\+METHOD}{MOCK\+\_\+\+METHOD}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2mocking_MOCK_METHOD}
...
\begin{DoxyTable}{2}{}{}{1}
\SetCell{c,bg=\tableheadbgcolor,font=\bfseries}Qualifier  &\SetCell{c,bg=\tableheadbgcolor,font=\bfseries}Meaning  \\
...
{\ttfamily Calltype(}\texorpdfstring{$\ast$}{*}{\ttfamily calltype}\texorpdfstring{$\ast$}{*}{\ttfamily )}  &Sets the call type for the method, for example {\ttfamily Calltype(\+STDMETHODCALLTYPE)}. Useful on Windows.  \\
{\ttfamily ref(}\texorpdfstring{$\ast$}{*}{\ttfamily qualifier}\texorpdfstring{$\ast$}{*}{\ttfamily )}  &Marks the method with the given reference qualifier, for example {\ttfamily ref(\&)} or {\ttfamily ref(\&\&)}. Required if overriding a method that has a reference qualifier.  \\
\end{DoxyTable}
...
{\ttfamily MOCK\+\_\+\+METHOD} must be used in the {\ttfamily public:\+} section of a mock class definition, regardless of whether the method being mocked is {\ttfamily public}, {\ttfamily protected}, or {\ttfamily private} in the base class.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2mocking_EXPECT_CALL}{}\doxysubsection{\texorpdfstring{EXPECT\+\_\+\+CALL}{EXPECT\+\_\+\+CALL}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2mocking_EXPECT_CALL}
...
See details for each modifier clause below.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2mocking_autotoc_md263}{}\doxysubsubsection{\texorpdfstring{With \{\+\#\+EXPECT\+\_\+\+CALL.\+With\}}{With \{\+\#\+EXPECT\+\_\+\+CALL.\+With\}}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2mocking_autotoc_md263}
...
Google\+Test passes all of the arguments as one tuple into the matcher. The parameter {\itshape {\ttfamily multi\+\_\+argument\+\_\+matcher}} must thus be a matcher of type {\ttfamily \doxylink{class_matcher}{Matcher}\texorpdfstring{$<$}{<}std::\+tuple\texorpdfstring{$<$}{<}A1, ..., An\texorpdfstring{$>$}{>}\texorpdfstring{$>$}{>}}, where {\ttfamily A1, ..., An} are the types of the function arguments.
...
The {\ttfamily With} clause can be used at most once on an expectation and must be the first clause.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2mocking_autotoc_md264}{}\doxysubsubsection{\texorpdfstring{Times \{\+\#\+EXPECT\+\_\+\+CALL.\+Times\}}{Times \{\+\#\+EXPECT\+\_\+\+CALL.\+Times\}}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2mocking_autotoc_md264}
{\ttfamily .Times(}\texorpdfstring{$\ast$}{*}{\ttfamily cardinality}\texorpdfstring{$\ast$}{*}{\ttfamily )}

Specifies how many times the mock function call is expected.

The parameter {\itshape {\ttfamily cardinality}} represents the number of expected calls and can be one of the following, all defined in the {\ttfamily ::\+testing} namespace:\+


\begin{DoxyTable}{2}{}{}{1}
\SetCell{c,bg=\tableheadbgcolor,font=\bfseries}Cardinality  &\SetCell{c,bg=\tableheadbgcolor,font=\bfseries}Meaning  \\
...
The {\ttfamily Times} clause can be used at most once on an expectation.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2mocking_autotoc_md265}{}\doxysubsubsection{\texorpdfstring{In\+Sequence \{\+\#\+EXPECT\+\_\+\+CALL.\+In\+Sequence\}}{In\+Sequence \{\+\#\+EXPECT\+\_\+\+CALL.\+In\+Sequence\}}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2mocking_autotoc_md265}
{\ttfamily .In\+Sequence(}\texorpdfstring{$\ast$}{*}{\ttfamily sequences...}\texorpdfstring{$\ast$}{*}{\ttfamily )}

Specifies that the mock function call is expected in a certain sequence.

The parameter {\itshape {\ttfamily sequences...}} is any number of \doxysectlink{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2mocking_Sequence}{\`{}\+Sequence\`{}}{2} objects. Expected calls assigned to the same sequence are expected to occur in the order the expectations are declared.
...
See also the \doxysectlink{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2mocking_InSequence}{\`{}\+In\+Sequence\`{} class}{2}.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2mocking_autotoc_md266}{}\doxysubsubsection{\texorpdfstring{After \{\+\#\+EXPECT\+\_\+\+CALL.\+After\}}{After \{\+\#\+EXPECT\+\_\+\+CALL.\+After\}}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2mocking_autotoc_md266}
...
The parameter {\itshape {\ttfamily expectations...}} can be up to five \doxysectlink{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2mocking_Expectation}{\`{}\+Expectation\`{}}{2} or \doxysectlink{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2mocking_ExpectationSet}{\`{}\+Expectation\+Set\`{}}{2} objects. The mock function call is expected to occur after all of the given expectations.
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{using\ }::testing::Expectation;}
\DoxyCodeLine{...}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{using\ }::testing::ExpectationSet;}
\DoxyCodeLine{...}
...
The {\ttfamily After} clause can be used any number of times on an expectation.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2mocking_autotoc_md267}{}\doxysubsubsection{\texorpdfstring{Will\+Once \{\+\#\+EXPECT\+\_\+\+CALL.\+Will\+Once\}}{Will\+Once \{\+\#\+EXPECT\+\_\+\+CALL.\+Will\+Once\}}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2mocking_autotoc_md267}
...
The parameter {\itshape {\ttfamily action}} represents the \href{../gmock_for_dummies.md\#actions-what-should-it-do}{\texttt{action}} that the function call will perform. See the \doxysectlink{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2actions}{Actions Reference}{0} for a list of built-\/in actions.
...
The {\ttfamily Will\+Once} clause can be used any number of times on an expectation. Unlike {\ttfamily Will\+Repeatedly}, the action fed to each {\ttfamily Will\+Once} call will be called at most once, so may be a move-\/only type and/\+or have an {\ttfamily \&\&}-\/qualified call operator.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2mocking_autotoc_md268}{}\doxysubsubsection{\texorpdfstring{Will\+Repeatedly \{\+\#\+EXPECT\+\_\+\+CALL.\+Will\+Repeatedly\}}{Will\+Repeatedly \{\+\#\+EXPECT\+\_\+\+CALL.\+Will\+Repeatedly\}}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2mocking_autotoc_md268}
...
The {\ttfamily Will\+Repeatedly} clause can be used at most once on an expectation.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2mocking_autotoc_md269}{}\doxysubsubsection{\texorpdfstring{Retires\+On\+Saturation \{\+\#\+EXPECT\+\_\+\+CALL.\+Retires\+On\+Saturation\}}{Retires\+On\+Saturation \{\+\#\+EXPECT\+\_\+\+CALL.\+Retires\+On\+Saturation\}}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2mocking_autotoc_md269}
...
The {\ttfamily Retires\+On\+Saturation} clause can be used at most once on an expectation and must be the last clause.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2mocking_ON_CALL}{}\doxysubsection{\texorpdfstring{ON\+\_\+\+CALL}{ON\+\_\+\+CALL}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2mocking_ON_CALL}
...
The parameter {\itshape {\ttfamily matchers...}} is a comma-\/separated list of \href{../gmock_for_dummies.md\#matchers-what-arguments-do-we-expect}{\texttt{matchers}} that correspond to each argument of the method {\itshape {\ttfamily method\+\_\+name}}. The {\ttfamily ON\+\_\+\+CALL} specification will apply only to calls of {\itshape {\ttfamily method\+\_\+name}} whose arguments match all of the matchers. If {\ttfamily (}\texorpdfstring{$\ast$}{*}{\ttfamily matchers...}\texorpdfstring{$\ast$}{*}{\ttfamily )} is omitted, the behavior is as if each argument\textquotesingle{}s matcher were a \href{matchers.md\#wildcard}{\texttt{wildcard matcher ({\ttfamily \+\_\+})}}. See the \doxysectlink{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2matchers}{Matchers Reference}{0} for a list of all built-\/in matchers.
...
See details for each modifier clause below.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2mocking_autotoc_md270}{}\doxysubsubsection{\texorpdfstring{With \{\+\#\+ON\+\_\+\+CALL.\+With\}}{With \{\+\#\+ON\+\_\+\+CALL.\+With\}}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2mocking_autotoc_md270}
{\ttfamily .With(}\texorpdfstring{$\ast$}{*}{\ttfamily multi\+\_\+argument\+\_\+matcher}\texorpdfstring{$\ast$}{*}{\ttfamily )}
...
The {\ttfamily With} clause can be used at most once with each {\ttfamily ON\+\_\+\+CALL} statement.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2mocking_autotoc_md271}{}\doxysubsubsection{\texorpdfstring{Will\+By\+Default \{\+\#\+ON\+\_\+\+CALL.\+Will\+By\+Default\}}{Will\+By\+Default \{\+\#\+ON\+\_\+\+CALL.\+Will\+By\+Default\}}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2mocking_autotoc_md271}
...
The {\ttfamily Will\+By\+Default} clause must be used exactly once with each {\ttfamily ON\+\_\+\+CALL} statement.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2mocking_classes}{}\doxysection{\texorpdfstring{Classes}{Classes}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2mocking_classes}
Google\+Test defines the following classes for working with mocks.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2mocking_DefaultValue}{}\doxysubsection{\texorpdfstring{Setting the Default Value for a Return Type}{Setting the Default Value for a Return Type}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2mocking_DefaultValue}
...
\end{DoxyCode}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2mocking_NiceMock}{}\doxysubsection{\texorpdfstring{Nice\+Mock}{Nice\+Mock}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2mocking_NiceMock}
{\ttfamily \doxylink{classtesting_1_1_nice_mock}{testing::\+\+Nice\+Mock}\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}}

Represents a mock object that suppresses warnings on \href{../gmock_cook_book.md\#uninteresting-vs-unexpected}{\texttt{uninteresting calls}}. The template parameter {\ttfamily T} is any mock class, except for another {\ttfamily Nice\+Mock}, {\ttfamily \doxylink{class_naggy_mock}{Naggy\+Mock}}, or {\ttfamily Strict\+Mock}.
...
{\ttfamily Nice\+Mock\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}} might not work correctly if the destructor of {\ttfamily T} is not virtual.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2mocking_NaggyMock}{}\doxysubsection{\texorpdfstring{Naggy\+Mock}{Naggy\+Mock}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2mocking_NaggyMock}
{\ttfamily \doxylink{classtesting_1_1_naggy_mock}{testing::\+\+Naggy\+Mock}\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}}

Represents a mock object that generates warnings on \href{../gmock_cook_book.md\#uninteresting-vs-unexpected}{\texttt{uninteresting calls}}. The template parameter {\ttfamily T} is any mock class, except for another {\ttfamily Nice\+Mock}, {\ttfamily \doxylink{class_naggy_mock}{Naggy\+Mock}}, or {\ttfamily Strict\+Mock}.

Usage of {\ttfamily \doxylink{class_naggy_mock}{Naggy\+Mock}\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}} is analogous to usage of {\ttfamily T}. {\ttfamily \doxylink{class_naggy_mock}{Naggy\+Mock}\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}} is a subclass of {\ttfamily T}, so it can be used wherever an object of type {\ttfamily T} is accepted. In addition, {\ttfamily \doxylink{class_naggy_mock}{Naggy\+Mock}\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}} can be constructed with any arguments that a constructor of {\ttfamily T} accepts.
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{using\ }::\doxymbox{\hyperlink{classtesting_1_1_naggy_mock}{testing::NaggyMock}};}
\DoxyCodeLine{...}
...
\doxylink{class_mock}{Mock} objects of type {\ttfamily T} by default behave the same way as {\ttfamily \doxylink{class_naggy_mock}{Naggy\+Mock}\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}}.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2mocking_StrictMock}{}\doxysubsection{\texorpdfstring{Strict\+Mock}{Strict\+Mock}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2mocking_StrictMock}
{\ttfamily \doxylink{classtesting_1_1_strict_mock}{testing::\+\+Strict\+Mock}\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}}

Represents a mock object that generates test failures on \href{../gmock_cook_book.md\#uninteresting-vs-unexpected}{\texttt{uninteresting calls}}. The template parameter {\ttfamily T} is any mock class, except for another {\ttfamily Nice\+Mock}, {\ttfamily \doxylink{class_naggy_mock}{Naggy\+Mock}}, or {\ttfamily Strict\+Mock}.
...
{\ttfamily Strict\+Mock\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}} might not work correctly if the destructor of {\ttfamily T} is not virtual.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2mocking_Sequence}{}\doxysubsection{\texorpdfstring{Sequence}{Sequence}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2mocking_Sequence}
{\ttfamily ::\+testing::\+\+Sequence}

Represents a chronological sequence of expectations. See the \`{}\+In\+Sequence\`{} clause of {\ttfamily EXPECT\+\_\+\+CALL} for usage.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2mocking_InSequence}{}\doxysubsection{\texorpdfstring{In\+Sequence}{In\+Sequence}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2mocking_InSequence}
...
The name of the {\ttfamily In\+Sequence} object does not matter.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2mocking_Expectation}{}\doxysubsection{\texorpdfstring{Expectation}{Expectation}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2mocking_Expectation}
{\ttfamily ::\+testing::\+\+Expectation}

Represents a mock function call expectation as created by \doxysectlink{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2mocking_EXPECT_CALL}{\`{}\+EXPECT\+\_\+\+CALL\`{}}{2}:\+
...
Useful for specifying sequences of expectations; see the \`{}\+After\`{} clause of {\ttfamily EXPECT\+\_\+\+CALL}.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2mocking_ExpectationSet}{}\doxysubsection{\texorpdfstring{Expectation\+Set}{Expectation\+Set}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2mocking_ExpectationSet}
{\ttfamily ::\+testing::\+\+Expectation\+Set}

Represents a set of mock function call expectations.

Use the {\ttfamily +=} operator to add \doxysectlink{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2mocking_Expectation}{\`{}\+Expectation\`{}}{2} objects to the set:\+
