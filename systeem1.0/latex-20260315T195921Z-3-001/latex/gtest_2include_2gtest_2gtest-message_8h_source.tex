...
\hypertarget{gtest_2include_2gtest_2gtest-message_8h_source}{}\label{gtest_2include_2gtest_2gtest-message_8h_source}\index{gtest/include/gtest/gtest-\/message.h@{gtest/include/gtest/gtest-\/message.h}}
...
\DoxyCodeLine{00085\ \textcolor{keyword}{class\ }GTEST\_API\_\ \doxymbox{\hyperlink{classtesting_1_1_message}{Message}}\ \{}
...
\DoxyCodeLine{00093\ \ \ Message();}
\DoxyCodeLine{00094\ }
\DoxyCodeLine{00095\ \ \ \textcolor{comment}{//\ Copy\ constructor.}}
\DoxyCodeLine{00096\ \ \ Message(\textcolor{keyword}{const}\ Message\&\ msg)\ :\ ss\_(new\ ::std::stringstream)\ \{\ \ \textcolor{comment}{//\ NOLINT}}
\DoxyCodeLine{00097\ \ \ \ \ *ss\_\ <<\ msg.GetString();}
\DoxyCodeLine{00098\ \ \ \}}
\DoxyCodeLine{00099\ }
\DoxyCodeLine{00100\ \ \ \textcolor{comment}{//\ Constructs\ a\ Message\ from\ a\ C-\/string.}}
\DoxyCodeLine{00101\ \ \ \textcolor{keyword}{explicit}\ Message(\textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ str)\ :\ ss\_(new\ ::std::stringstream)\ \{}
...
\DoxyCodeLine{00108\ \ \ \textcolor{keyword}{inline}\ Message\&\ operator\ <<(\textcolor{keyword}{const}\ T\&\ value)\ \{}
\DoxyCodeLine{00109\ \ \ \ \ StreamHelper(\textcolor{keyword}{typename}\ internal::is\_pointer<T>::type(),\ value);}
...
\DoxyCodeLine{00115\ \ \ \textcolor{keyword}{inline}\ Message\&\ operator\ <<(\textcolor{keyword}{const}\ T\&\ val)\ \{}
...
\DoxyCodeLine{00130\ \ \ \ \ \textcolor{keyword}{using\ }::\textcolor{keyword}{operator}\ <<;}
...
\DoxyCodeLine{00149\ \ \ \textcolor{keyword}{inline}\ Message\&\ operator\ <<(T*\ \textcolor{keyword}{const}\&\ pointer)\ \{\ \ \textcolor{comment}{//\ NOLINT}}
...
\DoxyCodeLine{00165\ \ \ Message\&\ operator\ <<(BasicNarrowIoManip\ val)\ \{}
...
\DoxyCodeLine{00171\ \ \ Message\&\ operator\ <<(\textcolor{keywordtype}{bool}\ b)\ \{}
...
\DoxyCodeLine{00177\ \ \ Message\&\ operator\ <<(\textcolor{keyword}{const}\ \textcolor{keywordtype}{wchar\_t}*\ wide\_c\_str);}
\DoxyCodeLine{00178\ \ \ Message\&\ operator\ <<(\textcolor{keywordtype}{wchar\_t}*\ wide\_c\_str);}
\DoxyCodeLine{00179\ }
...
\DoxyCodeLine{00183\ \ \ Message\&\ operator\ <<(const\ ::std::wstring\&\ wstr);}
...
\DoxyCodeLine{00189\ \ \ Message\&\ operator\ <<(const\ ::wstring\&\ wstr);}
...
\DoxyCodeLine{00206\ \ \ \textcolor{keyword}{inline}\ \textcolor{keywordtype}{void}\ StreamHelper(internal::true\_type\ \textcolor{comment}{/*is\_pointer*/},\ T*\ pointer)\ \{}
...
\DoxyCodeLine{00214\ \ \ \textcolor{keyword}{inline}\ \textcolor{keywordtype}{void}\ StreamHelper(internal::false\_type\ \textcolor{comment}{/*is\_pointer*/},}
...
\DoxyCodeLine{00218\ \ \ \ \ \textcolor{keyword}{using\ }::\textcolor{keyword}{operator}\ <<;}
...
\DoxyCodeLine{00224\ \ \ \textcolor{keyword}{const}\ internal::scoped\_ptr<\ ::std::stringstream>\ ss\_;}
\DoxyCodeLine{00225\ }
...
\DoxyCodeLine{00228\ \ \ \textcolor{keywordtype}{void}\ operator=(\textcolor{keyword}{const}\ Message\&);}
\DoxyCodeLine{00229\ \};}
\DoxyCodeLine{00230\ }
\DoxyCodeLine{00231\ \textcolor{comment}{//\ Streams\ a\ Message\ to\ an\ ostream.}}
\DoxyCodeLine{00232\ \textcolor{keyword}{inline}\ std::ostream\&\ operator\ <<(std::ostream\&\ os,\ \textcolor{keyword}{const}\ \doxymbox{\hyperlink{classtesting_1_1_message}{Message}}\&\ sb)\ \{}
