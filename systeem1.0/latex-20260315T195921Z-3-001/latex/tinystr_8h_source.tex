...
\hypertarget{tinystr_8h_source}{}\label{tinystr_8h_source}\index{include/tinystr.h@{include/tinystr.h}}
...
\DoxyCodeLine{00055\ \textcolor{keyword}{class\ }TiXmlString}
\DoxyCodeLine{00056\ \{}
...
\DoxyCodeLine{00066\ \ \ \ \ TiXmlString\ ()\ :\ rep\_(\&nullrep\_)}
\DoxyCodeLine{00067\ \ \ \ \ \{}
\DoxyCodeLine{00068\ \ \ \ \ \}}
\DoxyCodeLine{00069\ }
\DoxyCodeLine{00070\ \ \ \ \ \textcolor{comment}{//\ TiXmlString\ copy\ constructor}}
\DoxyCodeLine{00071\ \ \ \ \ TiXmlString\ (\ \textcolor{keyword}{const}\ TiXmlString\ \&\ copy)\ :\ rep\_(0)}
\DoxyCodeLine{00072\ \ \ \ \ \{}
...
\DoxyCodeLine{00078\ \ \ \ \ TIXML\_EXPLICIT\ TiXmlString\ (\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}\ *\ copy)\ :\ rep\_(0)}
\DoxyCodeLine{00079\ \ \ \ \ \{}
...
\DoxyCodeLine{00085\ \ \ \ \ TIXML\_EXPLICIT\ TiXmlString\ (\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}\ *\ str,\ size\_type\ len)\ :\ rep\_(0)}
\DoxyCodeLine{00086\ \ \ \ \ \{}
...
\DoxyCodeLine{00092\ \ \ \ \ \string~TiXmlString\ ()}
\DoxyCodeLine{00093\ \ \ \ \ \{}
\DoxyCodeLine{00094\ \ \ \ \ \ \ \ \ quit();}
\DoxyCodeLine{00095\ \ \ \ \ \}}
\DoxyCodeLine{00096\ }
\DoxyCodeLine{00097\ \ \ \ \ TiXmlString\&\ operator\ =\ (\textcolor{keyword}{const}\ \textcolor{keywordtype}{char}\ *\ copy)}
\DoxyCodeLine{00098\ \ \ \ \ \{}
\DoxyCodeLine{00099\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ assign(\ copy,\ (size\_type)strlen(copy));}
\DoxyCodeLine{00100\ \ \ \ \ \}}
\DoxyCodeLine{00101\ }
\DoxyCodeLine{00102\ \ \ \ \ TiXmlString\&\ operator\ =\ (\textcolor{keyword}{const}\ TiXmlString\ \&\ copy)}
\DoxyCodeLine{00103\ \ \ \ \ \{}
...
\DoxyCodeLine{00109\ \ \ \ \ TiXmlString\&\ operator\ +=\ (\textcolor{keyword}{const}\ \textcolor{keywordtype}{char}\ *\ suffix)}
\DoxyCodeLine{00110\ \ \ \ \ \{}
...
\DoxyCodeLine{00115\ \ \ \ \ TiXmlString\&\ operator\ +=\ (\textcolor{keywordtype}{char}\ single)}
\DoxyCodeLine{00116\ \ \ \ \ \{}
...
\DoxyCodeLine{00121\ \ \ \ \ TiXmlString\&\ operator\ +=\ (\textcolor{keyword}{const}\ TiXmlString\ \&\ suffix)}
\DoxyCodeLine{00122\ \ \ \ \ \{}
...
\DoxyCodeLine{00192\ }
\DoxyCodeLine{00193\ \ \ \ \ TiXmlString\&\ assign\ (\textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ str,\ size\_type\ len);}
\DoxyCodeLine{00194\ }
\DoxyCodeLine{00195\ \ \ \ \ TiXmlString\&\ append\ (\textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ str,\ size\_type\ len);}
\DoxyCodeLine{00196\ }
\DoxyCodeLine{00197\ \ \ \ \ \textcolor{keywordtype}{void}\ swap\ (TiXmlString\&\ other)}
\DoxyCodeLine{00198\ \ \ \ \ \{}
...
\DoxyCodeLine{00227\ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ size\_type\ intsNeeded\ =\ (\ bytesNeeded\ +\ \textcolor{keyword}{sizeof}(int)\ -\/\ 1\ )\ /\ \textcolor{keyword}{sizeof}(\ \textcolor{keywordtype}{int}\ );\ }
...
\DoxyCodeLine{00253\ }
\DoxyCodeLine{00254\ }
\DoxyCodeLine{00255\ \textcolor{keyword}{inline}\ \textcolor{keywordtype}{bool}\ operator\ ==\ (\textcolor{keyword}{const}\ \doxymbox{\hyperlink{class_ti_xml_string}{TiXmlString}}\ \&\ a,\ \textcolor{keyword}{const}\ \doxymbox{\hyperlink{class_ti_xml_string}{TiXmlString}}\ \&\ b)}
\DoxyCodeLine{00256\ \{}
...
\DoxyCodeLine{00259\ \}}
\DoxyCodeLine{00260\ \textcolor{keyword}{inline}\ \textcolor{keywordtype}{bool}\ operator\ <\ (\textcolor{keyword}{const}\ \doxymbox{\hyperlink{class_ti_xml_string}{TiXmlString}}\ \&\ a,\ \textcolor{keyword}{const}\ \doxymbox{\hyperlink{class_ti_xml_string}{TiXmlString}}\ \&\ b)}
\DoxyCodeLine{00261\ \{}
\DoxyCodeLine{00262\ \ \ \ \ \textcolor{keywordflow}{return}\ strcmp(a.c\_str(),\ b.c\_str())\ <\ 0;}
\DoxyCodeLine{00263\ \}}
\DoxyCodeLine{00264\ }
\DoxyCodeLine{00265\ \textcolor{keyword}{inline}\ \textcolor{keywordtype}{bool}\ operator\ !=\ (\textcolor{keyword}{const}\ \doxymbox{\hyperlink{class_ti_xml_string}{TiXmlString}}\ \&\ a,\ \textcolor{keyword}{const}\ \doxymbox{\hyperlink{class_ti_xml_string}{TiXmlString}}\ \&\ b)\ \{\ \textcolor{keywordflow}{return}\ !(a\ ==\ b);\ \}}
\DoxyCodeLine{00266\ \textcolor{keyword}{inline}\ \textcolor{keywordtype}{bool}\ operator\ >\ \ (\textcolor{keyword}{const}\ \doxymbox{\hyperlink{class_ti_xml_string}{TiXmlString}}\ \&\ a,\ \textcolor{keyword}{const}\ \doxymbox{\hyperlink{class_ti_xml_string}{TiXmlString}}\ \&\ b)\ \{\ \textcolor{keywordflow}{return}\ b\ <\ a;\ \}}
\DoxyCodeLine{00267\ \textcolor{keyword}{inline}\ \textcolor{keywordtype}{bool}\ operator\ <=\ (\textcolor{keyword}{const}\ \doxymbox{\hyperlink{class_ti_xml_string}{TiXmlString}}\ \&\ a,\ \textcolor{keyword}{const}\ \doxymbox{\hyperlink{class_ti_xml_string}{TiXmlString}}\ \&\ b)\ \{\ \textcolor{keywordflow}{return}\ !(b\ <\ a);\ \}}
\DoxyCodeLine{00268\ \textcolor{keyword}{inline}\ \textcolor{keywordtype}{bool}\ operator\ >=\ (\textcolor{keyword}{const}\ \doxymbox{\hyperlink{class_ti_xml_string}{TiXmlString}}\ \&\ a,\ \textcolor{keyword}{const}\ \doxymbox{\hyperlink{class_ti_xml_string}{TiXmlString}}\ \&\ b)\ \{\ \textcolor{keywordflow}{return}\ !(a\ <\ b);\ \}}
\DoxyCodeLine{00269\ }
\DoxyCodeLine{00270\ \textcolor{keyword}{inline}\ \textcolor{keywordtype}{bool}\ operator\ ==\ (\textcolor{keyword}{const}\ \doxymbox{\hyperlink{class_ti_xml_string}{TiXmlString}}\ \&\ a,\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ b)\ \{\ \textcolor{keywordflow}{return}\ strcmp(a.c\_str(),\ b)\ ==\ 0;\ \}}
\DoxyCodeLine{00271\ \textcolor{keyword}{inline}\ \textcolor{keywordtype}{bool}\ operator\ ==\ (\textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ a,\ \textcolor{keyword}{const}\ \doxymbox{\hyperlink{class_ti_xml_string}{TiXmlString}}\ \&\ b)\ \{\ \textcolor{keywordflow}{return}\ b\ ==\ a;\ \}}
\DoxyCodeLine{00272\ \textcolor{keyword}{inline}\ \textcolor{keywordtype}{bool}\ operator\ !=\ (\textcolor{keyword}{const}\ \doxymbox{\hyperlink{class_ti_xml_string}{TiXmlString}}\ \&\ a,\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ b)\ \{\ \textcolor{keywordflow}{return}\ !(a\ ==\ b);\ \}}
\DoxyCodeLine{00273\ \textcolor{keyword}{inline}\ \textcolor{keywordtype}{bool}\ operator\ !=\ (\textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ a,\ \textcolor{keyword}{const}\ \doxymbox{\hyperlink{class_ti_xml_string}{TiXmlString}}\ \&\ b)\ \{\ \textcolor{keywordflow}{return}\ !(b\ ==\ a);\ \}}
\DoxyCodeLine{00274\ }
\DoxyCodeLine{00275\ \doxymbox{\hyperlink{class_ti_xml_string}{TiXmlString}}\ operator\ +\ (\textcolor{keyword}{const}\ \doxymbox{\hyperlink{class_ti_xml_string}{TiXmlString}}\ \&\ a,\ \textcolor{keyword}{const}\ \doxymbox{\hyperlink{class_ti_xml_string}{TiXmlString}}\ \&\ b);}
\DoxyCodeLine{00276\ \doxymbox{\hyperlink{class_ti_xml_string}{TiXmlString}}\ operator\ +\ (\textcolor{keyword}{const}\ \doxymbox{\hyperlink{class_ti_xml_string}{TiXmlString}}\ \&\ a,\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ b);}
\DoxyCodeLine{00277\ \doxymbox{\hyperlink{class_ti_xml_string}{TiXmlString}}\ operator\ +\ (\textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ a,\ \textcolor{keyword}{const}\ \doxymbox{\hyperlink{class_ti_xml_string}{TiXmlString}}\ \&\ b);}
\DoxyCodeLine{00278\ }
\DoxyCodeLine{00279\ }
...
\DoxyCodeLine{00284\ \textcolor{keyword}{class\ }\doxymbox{\hyperlink{class_ti_xml_out_stream}{TiXmlOutStream}}\ :\ \textcolor{keyword}{public}\ TiXmlString}
\DoxyCodeLine{00285\ \{}
\DoxyCodeLine{00286\ public\ :}
\DoxyCodeLine{00287\ }
\DoxyCodeLine{00288\ \ \ \ \ \textcolor{comment}{//\ TiXmlOutStream\ <<\ operator.}}
\DoxyCodeLine{00289\ \ \ \ \ \doxymbox{\hyperlink{class_ti_xml_out_stream}{TiXmlOutStream}}\ \&\ operator\ <<\ (\textcolor{keyword}{const}\ TiXmlString\ \&\ in)}
\DoxyCodeLine{00290\ \ \ \ \ \{}
...
\DoxyCodeLine{00296\ \ \ \ \ \doxymbox{\hyperlink{class_ti_xml_out_stream}{TiXmlOutStream}}\ \&\ operator\ <<\ (\textcolor{keyword}{const}\ \textcolor{keywordtype}{char}\ *\ in)}
\DoxyCodeLine{00297\ \ \ \ \ \{}
