...
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__for__dummies}{}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__for__dummies}\index{gMock for Dummies@{gMock for Dummies}}
\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__for__dummies_autotoc_md199}%
\Hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__for__dummies_autotoc_md199}%
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__for__dummies_autotoc_md200}{}\doxysection{\texorpdfstring{What Is g\+Mock?}{What Is g\+Mock?}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__for__dummies_autotoc_md200}
...
\end{DoxyEnumerate}\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__for__dummies_autotoc_md201}{}\doxysection{\texorpdfstring{Why g\+Mock?}{Why g\+Mock?}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__for__dummies_autotoc_md201}
...
\end{DoxyItemize}\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__for__dummies_autotoc_md202}{}\doxysection{\texorpdfstring{Getting Started}{Getting Started}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__for__dummies_autotoc_md202}
g\+Mock is bundled with googletest.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__for__dummies_autotoc_md203}{}\doxysection{\texorpdfstring{A Case for Mock Turtles}{A Case for Mock Turtles}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__for__dummies_autotoc_md203}
Let\textquotesingle{}s look at an example. Suppose you are developing a graphics program that relies on a \href{http://en.wikipedia.org/wiki/Logo_programming_language}{\texttt{LOGO}}-\/like API for drawing. How would you test that it does the right thing? Well, you can run it and compare the screen with a golden screen snapshot, but let\textquotesingle{}s admit it:\+ tests like this are expensive to run and fragile (What if you just upgraded to a shiny new graphics card that has better anti-\/aliasing? Suddenly you have to update all your golden images.). It would be too painful if all your tests are like this. Fortunately, you learned about \href{http://en.wikipedia.org/wiki/Dependency_injection}{\texttt{Dependency Injection}} and know the right thing to do:\+ instead of having your application talk to the system API directly, wrap the API in an interface (say, {\ttfamily Turtle}) and code to that interface:\+
...
You don\textquotesingle{}t need to define these mock methods somewhere else -\/ the {\ttfamily MOCK\+\_\+\+METHOD} macro will generate the definitions for you. It\textquotesingle{}s that simple!\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__for__dummies_autotoc_md206}{}\doxysubsection{\texorpdfstring{Where to Put It}{Where to Put It}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__for__dummies_autotoc_md206}
...
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{keyword}{using\ }::testing::AtLeast;\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ \#1}}
\DoxyCodeLine{}
...
Admittedly, this test is contrived and doesn\textquotesingle{}t do much. You can easily achieve the same effect without using g\+Mock. However, as we shall reveal soon, g\+Mock allows you to do {\itshape so much more} with the mocks.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__for__dummies_autotoc_md208}{}\doxysection{\texorpdfstring{Setting Expectations}{Setting Expectations}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__for__dummies_autotoc_md208}
The key to using a mock object successfully is to set the {\itshape right expectations} on it. If you set the expectations too strict, your test will fail as the result of unrelated changes. If you set them too loose, bugs can slip through. You want to do it just right such that your test can catch exactly the kind of bugs you intend it to catch. g\+Mock provides the necessary means for you to do it "{}just right."{}\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__for__dummies_autotoc_md209}{}\doxysubsection{\texorpdfstring{General Syntax}{General Syntax}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__for__dummies_autotoc_md209}
...
\{:\+ .callout .note\} {\bfseries{Note:\+}} Why do we use a macro to do this? Well it serves two purposes:\+ first it makes expectations easily identifiable (either by {\ttfamily grep} or by a human reader), and second it allows g\+Mock to include the source file location of a failed expectation in messages, making debugging easier.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__for__dummies_autotoc_md210}{}\doxysubsection{\texorpdfstring{Matchers:\+ What Arguments Do We Expect?}{Matchers:\+ What Arguments Do We Expect?}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__for__dummies_autotoc_md210}
...
In the above examples, {\ttfamily 100} and {\ttfamily 50} are also matchers; implicitly, they are the same as {\ttfamily Eq(100)} and {\ttfamily Eq(50)}, which specify that the argument must be equal (using {\ttfamily operator==}) to the matcher argument. There are many \doxysectlink{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2matchers}{built-\/in matchers}{0} for common types (as well as \href{gmock_cook_book.md\#NewMatchers}{\texttt{custom matchers}}); for example:\+
...
This works for all non-\/overloaded methods; if a method is overloaded, you need to help g\+Mock resolve which overload is expected by specifying the number of arguments and possibly also the \href{gmock_cook_book.md\#SelectOverload}{\texttt{types of the arguments}}.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__for__dummies_autotoc_md211}{}\doxysubsection{\texorpdfstring{Cardinalities:\+ How Many Times Will It Be Called?}{Cardinalities:\+ How Many Times Will It Be Called?}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__for__dummies_autotoc_md211}
...
{\bfseries{Quick quiz:\+}} what do you think will happen if a function is expected to be called twice but actually called four times?\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__for__dummies_autotoc_md212}{}\doxysubsection{\texorpdfstring{Actions:\+ What Should It Do?}{Actions:\+ What Should It Do?}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__for__dummies_autotoc_md212}
...
Instead of returning 100, 101, 102, ..., consecutively, this mock function will always return 100 as {\ttfamily n++} is only evaluated once. Similarly, {\ttfamily Return(new Foo)} will create a new {\ttfamily Foo} object when the {\ttfamily EXPECT\+\_\+\+CALL()} is executed, and will return the same pointer every time. If you want the side effect to happen every time, you need to define a custom action, which we\textquotesingle{}ll teach in the \doxysectlink{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book}{cook book}{0}.
...
(What if you care about the relative order of some of the calls, but not all of them? Can you specify an arbitrary partial order? The answer is ... yes! The details can be found \href{gmock_cook_book.md\#OrderedCalls}{\texttt{here}}.)\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__for__dummies_StickyExpectations}{}\doxysubsection{\texorpdfstring{All Expectations Are Sticky (Unless Said Otherwise)}{All Expectations Are Sticky (Unless Said Otherwise)}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__for__dummies_StickyExpectations}
