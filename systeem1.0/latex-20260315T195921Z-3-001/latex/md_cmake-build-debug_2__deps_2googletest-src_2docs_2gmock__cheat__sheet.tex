...
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cheat__sheet}{}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cheat__sheet}\index{gMock Cheat Sheet@{gMock Cheat Sheet}}
\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cheat__sheet_autotoc_md111}%
\Hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cheat__sheet_autotoc_md111}%
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cheat__sheet_autotoc_md112}{}\doxysection{\texorpdfstring{Defining a Mock Class}{Defining a Mock Class}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cheat__sheet_autotoc_md112}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cheat__sheet_MockClass}{}\doxysubsection{\texorpdfstring{Mocking a Normal Class}{Mocking a Normal Class}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cheat__sheet_MockClass}
Given
...
\DoxyCodeLine{\doxymbox{\hyperlink{class_naggy_mock}{NaggyMock<MockFoo>}}\ naggy\_foo;\ \ \ \ \textcolor{comment}{//\ The\ type\ is\ a\ subclass\ of\ MockFoo.}}
\DoxyCodeLine{StrictMock<MockFoo>\ strict\_foo;\ \ \textcolor{comment}{//\ The\ type\ is\ a\ subclass\ of\ MockFoo.}}

\end{DoxyCode}


\{:\+ .callout .note\} {\bfseries{Note:\+}} A mock object is currently naggy by default. We may make it nice by default in the future.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cheat__sheet_MockTemplate}{}\doxysubsection{\texorpdfstring{Mocking a Class Template}{Mocking a Class Template}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cheat__sheet_MockTemplate}
...
\end{DoxyCode}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cheat__sheet_autotoc_md113}{}\doxysubsection{\texorpdfstring{Specifying Calling Conventions for Mock Functions}{Specifying Calling Conventions for Mock Functions}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cheat__sheet_autotoc_md113}
...
where {\ttfamily STDMETHODCALLTYPE} is defined by {\ttfamily \texorpdfstring{$<$}{<}objbase.\+h\texorpdfstring{$>$}{>}} on Windows.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cheat__sheet_UsingMocks}{}\doxysection{\texorpdfstring{Using Mocks in Tests}{Using Mocks in Tests}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cheat__sheet_UsingMocks}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{using\ }::testing::Return;\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ \#1}}
\DoxyCodeLine{}
...
\end{DoxyCode}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cheat__sheet_OnCall}{}\doxysection{\texorpdfstring{Setting Default Actions}{Setting Default Actions}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cheat__sheet_OnCall}
...
To customize the default action for a particular method of a specific mock object, use \href{reference/mocking.md\#ON_CALL}{\texttt{{\ttfamily ON\+\_\+\+CALL}}}. {\ttfamily ON\+\_\+\+CALL} has a similar syntax to {\ttfamily EXPECT\+\_\+\+CALL}, but it is used for setting default behaviors when you do not require that the mock method is called. See \href{gmock_cook_book.md\#UseOnCall}{\texttt{Knowing When to Expect}} for a more detailed discussion.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cheat__sheet_ExpectCall}{}\doxysection{\texorpdfstring{Setting Expectations}{Setting Expectations}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cheat__sheet_ExpectCall}
See \href{reference/mocking.md\#EXPECT_CALL}{\texttt{{\ttfamily EXPECT\+\_\+\+CALL}}} in the Mocking Reference.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cheat__sheet_MatcherList}{}\doxysection{\texorpdfstring{Matchers}{Matchers}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cheat__sheet_MatcherList}
See the \doxysectlink{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2matchers}{Matchers Reference}{0}.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cheat__sheet_ActionList}{}\doxysection{\texorpdfstring{Actions}{Actions}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cheat__sheet_ActionList}
See the \doxysectlink{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2actions}{Actions Reference}{0}.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cheat__sheet_CardinalityList}{}\doxysection{\texorpdfstring{Cardinalities}{Cardinalities}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cheat__sheet_CardinalityList}
See the \href{reference/mocking.md\#EXPECT_CALL.Times}{\texttt{{\ttfamily Times} clause}} of {\ttfamily EXPECT\+\_\+\+CALL} in the Mocking Reference.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cheat__sheet_autotoc_md114}{}\doxysection{\texorpdfstring{Expectation Order}{Expectation Order}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cheat__sheet_autotoc_md114}
By default, expectations can be matched in {\itshape any} order. If some or all expectations must be matched in a given order, you can use the \href{reference/mocking.md\#EXPECT_CALL.After}{\texttt{{\ttfamily After} clause}} or \href{reference/mocking.md\#EXPECT_CALL.InSequence}{\texttt{{\ttfamily In\+Sequence} clause}} of {\ttfamily EXPECT\+\_\+\+CALL}, or use an \href{reference/mocking.md\#InSequence}{\texttt{{\ttfamily In\+Sequence} object}}.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cheat__sheet_autotoc_md115}{}\doxysection{\texorpdfstring{Verifying and Resetting a Mock}{Verifying and Resetting a Mock}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cheat__sheet_autotoc_md115}
...
\end{DoxyCode}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cheat__sheet_autotoc_md116}{}\doxysection{\texorpdfstring{Mock Classes}{Mock Classes}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cheat__sheet_autotoc_md116}
...
See this \href{gmock_cook_book.md\#UsingCheckPoints}{\texttt{recipe}} for one application of it.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cheat__sheet_autotoc_md117}{}\doxysection{\texorpdfstring{Flags}{Flags}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cheat__sheet_autotoc_md117}

\begin{DoxyTable}{2}{}{}{1}
\SetCell{bg=\tableheadbgcolor,font=\bfseries}Flag  &\SetCell{bg=\tableheadbgcolor,font=\bfseries}Description  \\
{\ttfamily -\/-\/gmock\+\_\+catch\+\_\+leaked\+\_\+mocks=0}  &Don\textquotesingle{}t report leaked mock objects as failures.  \\
{\ttfamily -\/-\/gmock\+\_\+verbose=LEVEL}  &Sets the default verbosity level ({\ttfamily info}, {\ttfamily warning}, or {\ttfamily error}) of Google \doxylink{class_mock}{Mock} messages.  \\
\end{DoxyTable}
